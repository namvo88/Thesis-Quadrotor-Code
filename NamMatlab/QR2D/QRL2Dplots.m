...
angleQR = simoutL.signals.values(10:12,:);
Omega = simoutL.signals.values(13:15,:);
dOmega = simoutL.signals.values(16:18,:);
...
f = simoutL.signals.values(19,:);
M = simoutL.signals.values(20:22,:);
omegarot = simoutL.signals.values(23:26,:);
fi = simoutL.signals.values(27:30,:);
