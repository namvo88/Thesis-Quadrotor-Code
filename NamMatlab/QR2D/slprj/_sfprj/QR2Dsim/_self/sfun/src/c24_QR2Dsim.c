...
static void initialize_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct *chartInstance);
static void initialize_params_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct
  *chartInstance);
static void enable_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct *chartInstance);
static void disable_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct *chartInstance);
static void c24_update_debugger_state_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct
  *chartInstance);
static void set_sim_state_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c24_st);
static void finalize_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct *chartInstance);
static void sf_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct *chartInstance);
static void c24_chartstep_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct *chartInstance);
static void initSimStructsc24_QR2Dsim(SFc24_QR2DsimInstanceStruct *chartInstance);
...
static const mxArray *c24_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static void c24_emlrt_marshallIn(SFc24_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c24_Out3, const char_T *c24_identifier, real_T c24_y[9]);
static void c24_b_emlrt_marshallIn(SFc24_QR2DsimInstanceStruct *chartInstance,
...
static const mxArray *c24_b_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static void c24_c_emlrt_marshallIn(SFc24_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c24_Out2, const char_T *c24_identifier, real_T c24_y[3]);
static void c24_d_emlrt_marshallIn(SFc24_QR2DsimInstanceStruct *chartInstance,
...
static const mxArray *c24_c_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static real_T c24_e_emlrt_marshallIn(SFc24_QR2DsimInstanceStruct *chartInstance,
...
static void c24_eml_scalar_eg(SFc24_QR2DsimInstanceStruct *chartInstance);
static void c24_b_eml_scalar_eg(SFc24_QR2DsimInstanceStruct *chartInstance);
static const mxArray *c24_d_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static int32_T c24_f_emlrt_marshallIn(SFc24_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void c24_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData);
static uint8_T c24_g_emlrt_marshallIn(SFc24_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c24_b_is_active_c24_QR2Dsim, const char_T *c24_identifier);
static uint8_T c24_h_emlrt_marshallIn(SFc24_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void init_dsm_address_info(SFc24_QR2DsimInstanceStruct *chartInstance);
...
static void initialize_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c24_is_active_c24_QR2Dsim = 0U;
}
  ...
  *chartInstance)
{
  ...
  c24_hoistedGlobal = chartInstance->c24_is_active_c24_QR2Dsim;
  ...
  const mxArray *c24_st)
{
  ...
  chartInstance->c24_is_active_c24_QR2Dsim = c24_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c24_u, 3)),
     "is_active_c24_QR2Dsim");
  sf_mex_destroy(&c24_u);
  c24_update_debugger_state_c24_QR2Dsim(chartInstance);
...
static void sf_c24_QR2Dsim(SFc24_QR2DsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c24_sfEvent = CALL_EVENT;
  c24_chartstep_c24_QR2Dsim(chartInstance);
  ...
  *c24_inData)
{
  ...
  real_T c24_u[9];
  const mxArray *c24_y = NULL;
  SFc24_QR2DsimInstanceStruct *chartInstance;
  chartInstance = (SFc24_QR2DsimInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c24_QR2Dsim_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c24_b_is_active_c24_QR2Dsim, const char_T *c24_identifier)
{
  ...
  c24_y = c24_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c24_b_is_active_c24_QR2Dsim), &c24_thisId);
  sf_mex_destroy(&c24_b_is_active_c24_QR2Dsim);
  return c24_y;
}
...
void sf_c24_QR2Dsim_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c24_QR2Dsim_get_autoinheritance_info(void)
{
...
mxArray *sf_c24_QR2Dsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c24_QR2Dsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c24_QR2Dsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[9],T\"Out1\",},{M[1],M[13],T\"Out2\",},{M[1],M[14],T\"Out3\",},{M[8],M[0],T\"is_active_c24_QR2Dsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c24_QR2Dsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc24_QR2DsimInstanceStruct *chartInstance;
    chartInstance = (SFc24_QR2DsimInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c24_QR2Dsim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc24_QR2DsimInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c24_QR2Dsim((SFc24_QR2DsimInstanceStruct*) chartInstanceVar);
  initialize_c24_QR2Dsim((SFc24_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c24_QR2Dsim(void *chartInstanceVar)
{
  enable_c24_QR2Dsim((SFc24_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c24_QR2Dsim(void *chartInstanceVar)
{
  disable_c24_QR2Dsim((SFc24_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c24_QR2Dsim(void *chartInstanceVar)
{
  sf_c24_QR2Dsim((SFc24_QR2DsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c24_QR2Dsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c24_QR2Dsim((SFc24_QR2DsimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c24_QR2Dsim();/* state var info */
...
extern void sf_internal_set_sim_state_c24_QR2Dsim(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c24_QR2Dsim((SFc24_QR2DsimInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c24_QR2Dsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c24_QR2Dsim(S);
}

static void sf_opaque_set_sim_state_c24_QR2Dsim(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c24_QR2Dsim(S, st);
}

static void sf_opaque_terminate_c24_QR2Dsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc24_QR2DsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QR2Dsim_optimization_info();
    }

    finalize_c24_QR2Dsim((SFc24_QR2DsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc24_QR2Dsim((SFc24_QR2DsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c24_QR2Dsim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c24_QR2Dsim((SFc24_QR2DsimInstanceStruct*)
      (((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c24_QR2Dsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c24_QR2Dsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c24_QR2Dsim(SimStruct *S)
{
  SFc24_QR2DsimInstanceStruct *chartInstance;
  chartInstance = (SFc24_QR2DsimInstanceStruct *)utMalloc(sizeof
    (SFc24_QR2DsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc24_QR2DsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c24_QR2Dsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c24_QR2Dsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c24_QR2Dsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c24_QR2Dsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c24_QR2Dsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c24_QR2Dsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c24_QR2Dsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c24_QR2Dsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c24_QR2Dsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c24_QR2Dsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c24_QR2Dsim;
...
void c24_QR2Dsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c24_QR2Dsim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c24_QR2Dsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c24_QR2Dsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c24_QR2Dsim_method_dispatcher.\n"
