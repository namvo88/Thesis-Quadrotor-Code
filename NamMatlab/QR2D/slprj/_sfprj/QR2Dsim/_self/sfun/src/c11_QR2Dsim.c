...
static const char * c11_debug_family_names[7] = { "nargin", "nargout", "R", "Rd",
  "Omega", "Omegad", "eOmega" };

/* Function Declarations */
static void initialize_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct *chartInstance);
static void initialize_params_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct
  *chartInstance);
static void enable_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct *chartInstance);
static void disable_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct *chartInstance);
static void c11_update_debugger_state_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct
  *chartInstance);
static void set_sim_state_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c11_st);
static void finalize_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct *chartInstance);
static void sf_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct *chartInstance);
static void c11_chartstep_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct *chartInstance);
static void initSimStructsc11_QR2Dsim(SFc11_QR2DsimInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c11_machineNumber, uint32_T
  c11_chartNumber);
static const mxArray *c11_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_emlrt_marshallIn(SFc11_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c11_eOmega, const char_T *c11_identifier, real_T c11_y[3]);
static void c11_b_emlrt_marshallIn(SFc11_QR2DsimInstanceStruct *chartInstance,
...
static const mxArray *c11_d_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static real_T c11_c_emlrt_marshallIn(SFc11_QR2DsimInstanceStruct *chartInstance,
...
static void c11_eml_scalar_eg(SFc11_QR2DsimInstanceStruct *chartInstance);
static void c11_b_eml_scalar_eg(SFc11_QR2DsimInstanceStruct *chartInstance);
static const mxArray *c11_e_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static int32_T c11_d_emlrt_marshallIn(SFc11_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static uint8_T c11_e_emlrt_marshallIn(SFc11_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c11_b_is_active_c11_QR2Dsim, const char_T *c11_identifier);
static uint8_T c11_f_emlrt_marshallIn(SFc11_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void init_dsm_address_info(SFc11_QR2DsimInstanceStruct *chartInstance);
...
static void initialize_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c11_is_active_c11_QR2Dsim = 0U;
}
  ...
  *chartInstance)
{
  ...
  c11_hoistedGlobal = chartInstance->c11_is_active_c11_QR2Dsim;
  ...
  const mxArray *c11_st)
{
  ...
  chartInstance->c11_is_active_c11_QR2Dsim = c11_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c11_u, 1)),
     "is_active_c11_QR2Dsim");
  sf_mex_destroy(&c11_u);
  c11_update_debugger_state_c11_QR2Dsim(chartInstance);
...
static void sf_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct *chartInstance)
{
  ...
  real_T (*c11_Rd)[9];
  real_T (*c11_R)[9];
  c11_Omegad = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 3);
  c11_Omega = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 2);
  c11_eOmega = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c11_Rd = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c11_i3 = 0; c11_i3 < 9; c11_i3++) {
    _SFD_DATA_RANGE_CHECK((*c11_Rd)[c11_i3], 1U);
  }
  ...
  for (c11_i6 = 0; c11_i6 < 3; c11_i6++) {
    _SFD_DATA_RANGE_CHECK((*c11_Omegad)[c11_i6], 4U);
  }

  chartInstance->c11_sfEvent = CALL_EVENT;
  c11_chartstep_c11_QR2Dsim(chartInstance);
...
static void c11_chartstep_c11_QR2Dsim(SFc11_QR2DsimInstanceStruct *chartInstance)
{
  ...
  for (c11_i10 = 0; c11_i10 < 3; c11_i10++) {
    c11_Omegad[c11_i10] = (*c11_b_Omegad)[c11_i10];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_nargout, 1U, c11_d_sf_marshallOut,
    c11_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c11_R, 2U, c11_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c11_Rd, 3U, c11_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c11_Omega, 4U, c11_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c11_Omegad, 5U, c11_b_sf_marshallOut);
  ...
  for (c11_i21 = 0; c11_i21 < 3; c11_i21++) {
    c11_b_b[c11_i21] = c11_Omegad[c11_i21];
  }
  ...
  *c11_inData)
{
  ...
  real_T c11_u[3];
  const mxArray *c11_y = NULL;
  SFc11_QR2DsimInstanceStruct *chartInstance;
  chartInstance = (SFc11_QR2DsimInstanceStruct *)chartInstanceVoid;
  ...
  *c11_inData)
{
  ...
  for (c11_i34 = 0; c11_i34 < 3; c11_i34++) {
    for (c11_i35 = 0; c11_i35 < 3; c11_i35++) {
      c11_b_inData[c11_i35 + c11_i33] = (*(real_T (*)[9])c11_inData)[c11_i35 +
        c11_i33];
    }
  ...
  for (c11_i37 = 0; c11_i37 < 3; c11_i37++) {
    for (c11_i38 = 0; c11_i38 < 3; c11_i38++) {
      c11_u[c11_i38 + c11_i36] = c11_b_inData[c11_i38 + c11_i36];
    }
...
const mxArray *sf_c11_QR2Dsim_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c11_b_is_active_c11_QR2Dsim, const char_T *c11_identifier)
{
  ...
  c11_y = c11_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c11_b_is_active_c11_QR2Dsim), &c11_thisId);
  sf_mex_destroy(&c11_b_is_active_c11_QR2Dsim);
  return c11_y;
}
...
void sf_c11_QR2Dsim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4114770652U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1981259325U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1666772760U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3605450366U);
}

mxArray *sf_c11_QR2Dsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("DYNI7M6AXfjayNGcxoZeZE");
...
mxArray *sf_c11_QR2Dsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c11_QR2Dsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c11_QR2Dsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"eOmega\",},{M[8],M[0],T\"is_active_c11_QR2Dsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c11_QR2Dsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc11_QR2DsimInstanceStruct *chartInstance;
    chartInstance = (SFc11_QR2DsimInstanceStruct *) ((ChartInfoStruct *)
...
{
  return "Jl2lwfkNE094G3KnRtg8AB";
}

static void sf_opaque_initialize_c11_QR2Dsim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc11_QR2DsimInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c11_QR2Dsim((SFc11_QR2DsimInstanceStruct*) chartInstanceVar);
  initialize_c11_QR2Dsim((SFc11_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c11_QR2Dsim(void *chartInstanceVar)
{
  enable_c11_QR2Dsim((SFc11_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c11_QR2Dsim(void *chartInstanceVar)
{
  disable_c11_QR2Dsim((SFc11_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c11_QR2Dsim(void *chartInstanceVar)
{
  sf_c11_QR2Dsim((SFc11_QR2DsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c11_QR2Dsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c11_QR2Dsim((SFc11_QR2DsimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c11_QR2Dsim();/* state var info */
...
extern void sf_internal_set_sim_state_c11_QR2Dsim(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c11_QR2Dsim((SFc11_QR2DsimInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c11_QR2Dsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c11_QR2Dsim(S);
}

static void sf_opaque_set_sim_state_c11_QR2Dsim(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c11_QR2Dsim(S, st);
}

static void sf_opaque_terminate_c11_QR2Dsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc11_QR2DsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QR2Dsim_optimization_info();
    }

    finalize_c11_QR2Dsim((SFc11_QR2DsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc11_QR2Dsim((SFc11_QR2DsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c11_QR2Dsim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c11_QR2Dsim((SFc11_QR2DsimInstanceStruct*)
      (((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c11_QR2Dsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(738008178U));
  ssSetChecksum1(S,(2150314738U));
  ssSetChecksum2(S,(1926304738U));
  ssSetChecksum3(S,(3669679926U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c11_QR2Dsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c11_QR2Dsim(SimStruct *S)
{
  SFc11_QR2DsimInstanceStruct *chartInstance;
  chartInstance = (SFc11_QR2DsimInstanceStruct *)utMalloc(sizeof
    (SFc11_QR2DsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc11_QR2DsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c11_QR2Dsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c11_QR2Dsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c11_QR2Dsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c11_QR2Dsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c11_QR2Dsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c11_QR2Dsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c11_QR2Dsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c11_QR2Dsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c11_QR2Dsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c11_QR2Dsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c11_QR2Dsim;
...
void c11_QR2Dsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c11_QR2Dsim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c11_QR2Dsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c11_QR2Dsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c11_QR2Dsim_method_dispatcher.\n"
