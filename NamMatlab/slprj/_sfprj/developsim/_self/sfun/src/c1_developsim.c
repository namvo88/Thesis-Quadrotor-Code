...
static void sf_c1_developsim(SFc1_developsimInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_l, 2U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_Gamma, 3U, c1_d_sf_marshallOut,
    c1_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 6U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_var, 7U, c1_b_sf_marshallOut);
  ...
  *c1_inData)
{
  ...
  for (c1_i23 = 0; c1_i23 < 4; c1_i23++) {
    for (c1_i24 = 0; c1_i24 < 4; c1_i24++) {
      c1_b_inData[c1_i24 + c1_i22] = (*(real_T (*)[16])c1_inData)[c1_i24 +
        c1_i22];
    }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i30 = 0; c1_i30 < 4; c1_i30++) {
    for (c1_i31 = 0; c1_i31 < 4; c1_i31++) {
      (*(real_T (*)[16])c1_outData)[c1_i31 + c1_i29] = c1_y[c1_i31 + c1_i29];
    }
  ...
  for (c1_j = 1; c1_j < 4; c1_j++) {
    ...
    for (c1_i44 = 0; c1_i44 < 4; c1_i44++) {
      for (c1_i45 = 0; c1_i45 < 4; c1_i45++) {
        c1_b_A[c1_i45 + c1_i43] = c1_A[c1_i45 + c1_i43];
      }
    ...
    if (c1_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      ...
      for (c1_i = c1_b_jp1j; c1_i <= c1_i46; c1_i++) {
        c1_b_i = c1_i;
  ...
  if (c1_d_alpha1 == 0.0) {
    ...
    for (c1_j = 1; c1_j <= c1_e_n; c1_j++) {
      ...
      if (c1_yjy != 0.0) {
        ...
        for (c1_ijA = c1_i47; c1_ijA <= c1_i48; c1_ijA++) {
          c1_b_ijA = c1_ijA;
          c1_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(504902248U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2327223071U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1972036483U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(950614074U);
}
...
mxArray *sf_c1_developsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("xrN34mVBXpznCRoj6nGc2F");
...
static void mdlSetWorkWidths_c1_developsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3326556924U));
  ssSetChecksum1(S,(1387623137U));
  ssSetChecksum2(S,(504096543U));
  ssSetChecksum3(S,(432777035U));
