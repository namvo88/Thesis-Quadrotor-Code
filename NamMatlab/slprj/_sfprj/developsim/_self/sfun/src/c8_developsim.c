...
static void initialize_c8_developsim(SFc8_developsimInstanceStruct
  *chartInstance);
static void initialize_params_c8_developsim(SFc8_developsimInstanceStruct
  *chartInstance);
static void enable_c8_developsim(SFc8_developsimInstanceStruct *chartInstance);
static void disable_c8_developsim(SFc8_developsimInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_developsim(SFc8_developsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c8_developsim(SFc8_developsimInstanceStruct *
  chartInstance);
static void set_sim_state_c8_developsim(SFc8_developsimInstanceStruct
  *chartInstance, const mxArray *c8_st);
static void finalize_c8_developsim(SFc8_developsimInstanceStruct *chartInstance);
static void sf_c8_developsim(SFc8_developsimInstanceStruct *chartInstance);
static void c8_chartstep_c8_developsim(SFc8_developsimInstanceStruct
  *chartInstance);
static void initSimStructsc8_developsim(SFc8_developsimInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_developsimInstanceStruct *chartInstance,
  const mxArray *c8_eRhat, const char_T *c8_identifier, real_T c8_y[9]);
static void c8_b_emlrt_marshallIn(SFc8_developsimInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[9]);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_developsimInstanceStruct *chartInstance,
...
static void c8_eml_scalar_eg(SFc8_developsimInstanceStruct *chartInstance);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_d_emlrt_marshallIn(SFc8_developsimInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_e_emlrt_marshallIn(SFc8_developsimInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_developsim, const char_T
  *c8_identifier);
static uint8_T c8_f_emlrt_marshallIn(SFc8_developsimInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_developsimInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_developsim = 0U;
}
  ...
  chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_developsim;
  ...
  *chartInstance, const mxArray *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_developsim = c8_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 1)),
     "is_active_c8_developsim");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_developsim(chartInstance);
...
static void sf_c8_developsim(SFc8_developsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_developsim(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  real_T c8_u[9];
  const mxArray *c8_y = NULL;
  SFc8_developsimInstanceStruct *chartInstance;
  chartInstance = (SFc8_developsimInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_developsim_get_eml_resolved_functions_info(void)
{
  ...
  *c8_identifier)
{
  ...
  c8_y = c8_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_developsim), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_developsim);
  return c8_y;
}
...
void sf_c8_developsim_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_developsim_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_developsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_developsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_developsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"eRhat\",},{M[8],M[0],T\"is_active_c8_developsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_developsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_developsimInstanceStruct *chartInstance;
    chartInstance = (SFc8_developsimInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c8_developsim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_developsimInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c8_developsim((SFc8_developsimInstanceStruct*)
    chartInstanceVar);
  initialize_c8_developsim((SFc8_developsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_developsim(void *chartInstanceVar)
{
  enable_c8_developsim((SFc8_developsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_developsim(void *chartInstanceVar)
{
  disable_c8_developsim((SFc8_developsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_developsim(void *chartInstanceVar)
{
  sf_c8_developsim((SFc8_developsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_developsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_developsim
    ((SFc8_developsimInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_developsim();/* state var info */
...
extern void sf_internal_set_sim_state_c8_developsim(SimStruct* S, const mxArray *
  st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_developsim((SFc8_developsimInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_developsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_developsim(S);
}

static void sf_opaque_set_sim_state_c8_developsim(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c8_developsim(S, st);
}

static void sf_opaque_terminate_c8_developsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_developsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_developsim_optimization_info();
    }

    finalize_c8_developsim((SFc8_developsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_developsim((SFc8_developsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_developsim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_developsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_developsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_developsim(SimStruct *S)
{
  SFc8_developsimInstanceStruct *chartInstance;
  chartInstance = (SFc8_developsimInstanceStruct *)utMalloc(sizeof
    (SFc8_developsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_developsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c8_developsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c8_developsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_developsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_developsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_developsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c8_developsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c8_developsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c8_developsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_developsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_developsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_developsim;
...
void c8_developsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_developsim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_developsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_developsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_developsim_method_dispatcher.\n"
