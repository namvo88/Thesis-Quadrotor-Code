...
static const char * c1_debug_family_names[11] = { "b", "d", "l", "Gamma",
  "QRinput", "nargin", "nargout", "var", "M", "f", "omega" };

/* Function Declarations */
static void initialize_c1_QRsim(SFc1_QRsimInstanceStruct *chartInstance);
static void initialize_params_c1_QRsim(SFc1_QRsimInstanceStruct *chartInstance);
static void enable_c1_QRsim(SFc1_QRsimInstanceStruct *chartInstance);
static void disable_c1_QRsim(SFc1_QRsimInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_QRsim(SFc1_QRsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_QRsim(SFc1_QRsimInstanceStruct
  *chartInstance);
static void set_sim_state_c1_QRsim(SFc1_QRsimInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_QRsim(SFc1_QRsimInstanceStruct *chartInstance);
static void sf_c1_QRsim(SFc1_QRsimInstanceStruct *chartInstance);
static void initSimStructsc1_QRsim(SFc1_QRsimInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_QRsimInstanceStruct *chartInstance, const
  mxArray *c1_omega, const char_T *c1_identifier, real_T c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_QRsimInstanceStruct *chartInstance, const
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_QRsimInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_QRsimInstanceStruct *chartInstance, const
...
static void c1_realmin(SFc1_QRsimInstanceStruct *chartInstance);
static void c1_eps(SFc1_QRsimInstanceStruct *chartInstance);
static void c1_eml_matlab_zgetrf(SFc1_QRsimInstanceStruct *chartInstance, real_T
  c1_A[16], real_T c1_b_A[16], int32_T c1_ipiv[4], int32_T *c1_info);
static int32_T c1_eml_ixamax(SFc1_QRsimInstanceStruct *chartInstance, int32_T
  c1_n, real_T c1_x[16], int32_T c1_ix0);
static void c1_check_forloop_overflow_error(SFc1_QRsimInstanceStruct
  *chartInstance, boolean_T c1_overflow);
static void c1_eml_xger(SFc1_QRsimInstanceStruct *chartInstance, int32_T c1_m,
  int32_T c1_n, real_T c1_alpha1, int32_T c1_ix0, int32_T c1_iy0, real_T c1_A[16],
  int32_T c1_ia0, real_T c1_b_A[16]);
static void c1_eml_warning(SFc1_QRsimInstanceStruct *chartInstance);
static void c1_eml_xtrsm(SFc1_QRsimInstanceStruct *chartInstance, real_T c1_A[16],
  real_T c1_B[4], real_T c1_b_B[4]);
static void c1_below_threshold(SFc1_QRsimInstanceStruct *chartInstance);
static void c1_eml_scalar_eg(SFc1_QRsimInstanceStruct *chartInstance);
static void c1_b_eml_xtrsm(SFc1_QRsimInstanceStruct *chartInstance, real_T c1_A
  [16], real_T c1_B[4], real_T c1_b_B[4]);
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_e_emlrt_marshallIn(SFc1_QRsimInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_f_emlrt_marshallIn(SFc1_QRsimInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_QRsim, const char_T *c1_identifier);
static uint8_T c1_g_emlrt_marshallIn(SFc1_QRsimInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_eml_matlab_zgetrf(SFc1_QRsimInstanceStruct *chartInstance,
  real_T c1_A[16], int32_T c1_ipiv[4], int32_T *c1_info);
static void c1_b_eml_xger(SFc1_QRsimInstanceStruct *chartInstance, int32_T c1_m,
  int32_T c1_n, real_T c1_alpha1, int32_T c1_ix0, int32_T c1_iy0, real_T c1_A[16],
  int32_T c1_ia0);
static void c1_c_eml_xtrsm(SFc1_QRsimInstanceStruct *chartInstance, real_T c1_A
  [16], real_T c1_B[4]);
static void c1_d_eml_xtrsm(SFc1_QRsimInstanceStruct *chartInstance, real_T c1_A
  [16], real_T c1_B[4]);
static void init_dsm_address_info(SFc1_QRsimInstanceStruct *chartInstance);
...
static void initialize_c1_QRsim(SFc1_QRsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_QRsim = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c1_omega)[4];
  c1_omega = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c1_st = NULL;
  c1_st = NULL;
  c1_y = NULL;
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_QRsim;
  ...
  const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_QRsim = c1_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_QRsim");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_QRsim(chartInstance);
...
static void sf_c1_QRsim(SFc1_QRsimInstanceStruct *chartInstance)
{
  ...
  real_T (*c1_b_M)[3];
  real_T (*c1_b_var)[3];
  c1_b_omega = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c1_b_f = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c1_b_M = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  c1_b_var = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  for (c1_i2 = 0; c1_i2 < 3; c1_i2++) {
    _SFD_DATA_RANGE_CHECK((*c1_b_var)[c1_i2], 0U);
  }

  for (c1_i3 = 0; c1_i3 < 3; c1_i3++) {
    _SFD_DATA_RANGE_CHECK((*c1_b_M)[c1_i3], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*c1_b_f, 2U);
  for (c1_i4 = 0; c1_i4 < 4; c1_i4++) {
    _SFD_DATA_RANGE_CHECK((*c1_b_omega)[c1_i4], 3U);
  }

  chartInstance->c1_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  c1_hoistedGlobal = *c1_b_f;
  for (c1_i5 = 0; c1_i5 < 3; c1_i5++) {
    c1_var[c1_i5] = (*c1_b_var)[c1_i5];
  }

  for (c1_i6 = 0; c1_i6 < 3; c1_i6++) {
    c1_M[c1_i6] = (*c1_b_M)[c1_i6];
  }

  c1_f = c1_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 11U, 11U, c1_debug_family_names,
    c1_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_b, 0U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_l, 2U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_Gamma, 3U, c1_e_sf_marshallOut,
    c1_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_QRinput, 4U, c1_sf_marshallOut,
    c1_sf_marshallIn);
<<<<<<< HEAD
...
>>>>>>> developErrorAngularVelocity
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 6U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_var, 7U, c1_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_M, 8U, c1_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_f, 9U, c1_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_omega, 10U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c1_c_a = c1_l;
  c1_d_b = c1_b;
  c1_c_y = c1_c_a * c1_d_b;
  c1_d_a = -c1_l;
  c1_e_b = c1_b;
  c1_d_y = c1_d_a * c1_e_b;
  c1_Gamma[0] = c1_b;
  c1_Gamma[4] = c1_b;
  c1_Gamma[8] = c1_b;
  c1_Gamma[12] = c1_b;
  ...
  for (c1_i7 = 0; c1_i7 < 3; c1_i7++) {
    c1_QRinput[c1_i7 + 1] = c1_M[c1_i7];
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 13);
  for (c1_i8 = 0; c1_i8 < 16; c1_i8++) {
    c1_A[c1_i8] = c1_Gamma[c1_i8];
  }

  for (c1_i9 = 0; c1_i9 < 4; c1_i9++) {
    c1_B[c1_i9] = c1_QRinput[c1_i9];
  }

  c1_b_eml_matlab_zgetrf(chartInstance, c1_A, c1_ipiv, &c1_info);
  c1_b_info = c1_info;
  c1_c_info = c1_b_info;
  c1_d_info = c1_c_info;
  if (c1_d_info > 0) {
  ...
  for (c1_i = 1; c1_i < 5; c1_i++) {
    ...
    if (c1_ipiv[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      ...
      c1_temp = c1_omega[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
        _SFD_INTEGER_CHECK("", (real_T)c1_b_i), 1, 4, 1, 0) - 1];
      c1_omega[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        (real_T)c1_b_i), 1, 4, 1, 0) - 1] = c1_omega[_SFD_EML_ARRAY_BOUNDS_CHECK
  ...
  for (c1_i12 = 0; c1_i12 < 16; c1_i12++) {
    c1_dv2[c1_i12] = c1_dv1[c1_i12];
  }

  c1_c_eml_xtrsm(chartInstance, c1_dv2, c1_omega);
  for (c1_i13 = 0; c1_i13 < 16; c1_i13++) {
    c1_dv3[c1_i13] = c1_A[c1_i13];
  }

  for (c1_i14 = 0; c1_i14 < 16; c1_i14++) {
    c1_dv4[c1_i14] = c1_dv3[c1_i14];
  }

  c1_d_eml_xtrsm(chartInstance, c1_dv4, c1_omega);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -13);
  _SFD_SYMBOL_SCOPE_POP();
  for (c1_i15 = 0; c1_i15 < 4; c1_i15++) {
    (*c1_b_omega)[c1_i15] = c1_omega[c1_i15];
  }
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u[4];
  const mxArray *c1_y = NULL;
  SFc1_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc1_QRsimInstanceStruct *)chartInstanceVoid;
  ...
  *c1_inData)
{
  ...
  for (c1_i25 = 0; c1_i25 < 4; c1_i25++) {
    for (c1_i26 = 0; c1_i26 < 4; c1_i26++) {
      c1_b_inData[c1_i26 + c1_i24] = (*(real_T (*)[16])c1_inData)[c1_i26 +
        c1_i24];
    }
  ...
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[16])
{
  real_T c1_dv6[16];
  int32_T c1_i30;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_dv6, 1, 0, 0U, 1, 0U, 2, 4, 4);
  for (c1_i30 = 0; c1_i30 < 16; c1_i30++) {
    c1_y[c1_i30] = c1_dv6[c1_i30];
  }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  SFc1_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc1_QRsimInstanceStruct *)chartInstanceVoid;
  c1_Gamma = sf_mex_dup(c1_mxArrayInData);
  c1_identifier = c1_varName;
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_Gamma), &c1_thisId, c1_y);
  sf_mex_destroy(&c1_Gamma);
  c1_i31 = 0;
  for (c1_i32 = 0; c1_i32 < 4; c1_i32++) {
    for (c1_i33 = 0; c1_i33 < 4; c1_i33++) {
      (*(real_T (*)[16])c1_outData)[c1_i33 + c1_i31] = c1_y[c1_i33 + c1_i31];
    }
...
const mxArray *sf_c1_QRsim_get_eml_resolved_functions_info(void)
{
  const mxArray *c1_nameCaptureInfo = NULL;
  c1_nameCaptureInfo = NULL;
  sf_mex_assign(&c1_nameCaptureInfo, sf_mex_createstruct("structure", 2, 115, 1),
                FALSE);
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("mldivide"), "name", "name", 2);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 2);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_lusolve.m"), "resolved",
                  "resolved", 3);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1309451196U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 9);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("realmin"), "name", "name", 9);
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 23);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("colon"), "name", "name", 23);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
                  "resolved", 23);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1366162242U), "fileTimeLo",
                  "fileTimeLo", 23);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 23);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 24);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("colon"), "name", "name", 24);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_integer_colon_dispatcher"),
                  "context", "context", 32);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("intmin"), "name", "name", 32);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 32);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isa_uint.m"), "resolved",
                  "resolved", 34);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1286818784U), "fileTimeLo",
                  "fileTimeLo", 34);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 34);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1323170580U), "fileTimeLo",
                  "fileTimeLo", 35);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 35);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 43);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("intmax"), "name", "name", 43);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 43);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_ixamax.m!below_threshold"),
                  "context", "context", 55);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("length"), "name", "name", 55);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 55);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_ixamax.m"),
                  "context", "context", 58);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_refblas_ixamax"), "name",
                  "name", 58);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 58);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1299076770U), "fileTimeLo",
                  "fileTimeLo", 58);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 58);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1286818706U), "fileTimeLo",
                  "fileTimeLo", 60);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 60);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void c1_b_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1363713874U), "fileTimeLo",
                  "fileTimeLo", 66);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 66);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xswap.m"),
                  "context", "context", 69);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_refblas_xswap"), "name",
                  "name", 69);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 69);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1299076786U), "fileTimeLo",
                  "fileTimeLo", 69);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 69);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xswap.m"),
                  "context", "context", 71);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("abs"), "name", "name", 71);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 76);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_div"), "name", "name", 76);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 76);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1363713872U), "fileTimeLo",
                  "fileTimeLo", 77);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 77);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgeru.m"), "context",
                  "context", 79);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_xger"), "name", "name", 79);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 79);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xger.m!below_threshold"),
                  "context", "context", 82);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("min"), "name", "name", 82);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 82);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xger.m!below_threshold"),
                  "context", "context", 87);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("mtimes"), "name", "name", 87);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 87);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xger.m"),
                  "context", "context", 89);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_refblas_xger"), "name",
                  "name", 89);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 89);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1299076776U), "fileTimeLo",
                  "fileTimeLo", 89);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 89);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xger.m"),
                  "context", "context", 90);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_refblas_xgerx"), "name",
                  "name", 90);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 90);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1360282352U), "fileTimeLo",
                  "fileTimeLo", 90);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 90);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgerx.m"),
                  "context", "context", 92);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("abs"), "name", "name", 92);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1299076778U), "fileTimeLo",
                  "fileTimeLo", 100);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 100);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xtrsm.m!below_threshold"),
                  "context", "context", 102);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("mtimes"), "name", "name", 102);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 102);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xtrsm.m"),
                  "context", "context", 105);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_refblas_xtrsm"), "name",
                  "name", 105);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 105);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 113);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("intmin"), "name", "name", 113);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 113);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xtrsm.m"),
                  "context", "context", 114);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_div"), "name", "name", 114);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 114);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
  ...
  *chartInstance, boolean_T c1_overflow)
{
  ...
  if (!c1_overflow) {
    ...
    for (c1_i35 = 0; c1_i35 < 34; c1_i35++) {
      c1_u[c1_i35] = c1_cv0[c1_i35];
    }

    c1_y = NULL;
    sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 10, 0U, 1U, 0U, 2, 1, 34),
                  FALSE);
    for (c1_i36 = 0; c1_i36 < 23; c1_i36++) {
...
static void c1_eml_warning(SFc1_QRsimInstanceStruct *chartInstance)
{
  ...
  char_T c1_u[27];
  const mxArray *c1_y = NULL;
  for (c1_i38 = 0; c1_i38 < 27; c1_i38++) {
    c1_u[c1_i38] = c1_varargin_1[c1_i38];
  }
  ...
  const mxArray *c1_b_is_active_c1_QRsim, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_is_active_c1_QRsim),
    &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_QRsim);
  return c1_y;
}
  ...
  for (c1_j = 1; c1_j < 4; c1_j++) {
    ...
    for (c1_i46 = 0; c1_i46 < 4; c1_i46++) {
      for (c1_i47 = 0; c1_i47 < 4; c1_i47++) {
        c1_b_A[c1_i47 + c1_i45] = c1_A[c1_i47 + c1_i45];
      }
    ...
    if (c1_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      ...
      for (c1_i = c1_b_jp1j; c1_i <= c1_i48; c1_i++) {
        c1_b_i = c1_i;
    ...
    c1_ia0 = c1_g_c + 5;
    c1_d1 = -1.0;
    c1_b_eml_xger(chartInstance, c1_m, c1_n, c1_d1, c1_d_ix0, c1_d_iy0, c1_A,
                  c1_ia0);
  }
  ...
  if (c1_d_alpha1 == 0.0) {
    ...
    for (c1_j = 1; c1_j <= c1_e_n; c1_j++) {
      ...
      if (c1_yjy != 0.0) {
        ...
        for (c1_ijA = c1_i49; c1_ijA <= c1_i50; c1_ijA++) {
          c1_b_ijA = c1_ijA;
          c1_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
  ...
  for (c1_k = 4; c1_k > 0; c1_k--) {
    ...
    if (c1_B[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      ...
      for (c1_i = 1; c1_i <= c1_i52; c1_i++) {
        ...
        c1_B[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          (real_T)c1_g_c), 1, 4, 1, 0) - 1] = c1_B[_SFD_EML_ARRAY_BOUNDS_CHECK(
          "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c1_h_c), 1, 4, 1, 0) - 1]
          - c1_B[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          (real_T)c1_i_c), 1, 4, 1, 0) - 1] * c1_A[_SFD_EML_ARRAY_BOUNDS_CHECK(
...
void sf_c1_QRsim_get_check_sum(mxArray *plhs[])
{
<<<<<<< HEAD
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4262698911U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(679785512U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1590674193U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1463695917U);
=======
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1025829071U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(855089959U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4249235057U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3269485976U);
>>>>>>> developErrorAngularVelocity
}

mxArray *sf_c1_QRsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("guyWx0Geq30BDjBhOPqtOG");
...
mxArray *sf_c1_QRsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_QRsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_QRsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"omega\",},{M[8],M[0],T\"is_active_c1_QRsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_QRsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_QRsimInstanceStruct *chartInstance;
    chartInstance = (SFc1_QRsimInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(3,2,0,1,"omega");
...

        {
          ...
          real_T (*c1_omega)[4];
          c1_omega = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
          c1_f = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c1_M = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
          c1_var = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c1_var);
          _SFD_SET_DATA_VALUE_PTR(1U, *c1_M);
          _SFD_SET_DATA_VALUE_PTR(2U, c1_f);
          _SFD_SET_DATA_VALUE_PTR(3U, *c1_omega);
        }
      }
    } else {
...
{
<<<<<<< HEAD
  return "9uiZrMBIXzk9c1mO3CPuID";
=======
  return "n3Lq5fiAx3jlymsvvhFRTB";
>>>>>>> developErrorAngularVelocity
}

static void sf_opaque_initialize_c1_QRsim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_QRsimInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c1_QRsim((SFc1_QRsimInstanceStruct*) chartInstanceVar);
  initialize_c1_QRsim((SFc1_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_QRsim(void *chartInstanceVar)
{
  enable_c1_QRsim((SFc1_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_QRsim(void *chartInstanceVar)
{
  disable_c1_QRsim((SFc1_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_QRsim(void *chartInstanceVar)
{
  sf_c1_QRsim((SFc1_QRsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_QRsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_QRsim((SFc1_QRsimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_QRsim();/* state var info */
...
extern void sf_internal_set_sim_state_c1_QRsim(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_QRsim((SFc1_QRsimInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_QRsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_QRsim(S);
}

static void sf_opaque_set_sim_state_c1_QRsim(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_QRsim(S, st);
}

static void sf_opaque_terminate_c1_QRsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_QRsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QRsim_optimization_info();
    }

    finalize_c1_QRsim((SFc1_QRsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_QRsim((SFc1_QRsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_QRsim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_QRsim((SFc1_QRsimInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
<<<<<<< HEAD
  ssSetChecksum0(S,(1328777902U));
  ssSetChecksum1(S,(3384505769U));
  ssSetChecksum2(S,(868777335U));
  ssSetChecksum3(S,(4221439212U));
=======
  ssSetChecksum0(S,(1934527997U));
  ssSetChecksum1(S,(3011197973U));
  ssSetChecksum2(S,(3866763828U));
  ssSetChecksum3(S,(258802973U));
>>>>>>> developErrorAngularVelocity
...
static void mdlRTW_c1_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_QRsim(SimStruct *S)
{
  SFc1_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc1_QRsimInstanceStruct *)utMalloc(sizeof
    (SFc1_QRsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_QRsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_QRsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_QRsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_QRsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_QRsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_QRsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_QRsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_QRsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_QRsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_QRsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_QRsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_QRsim;
...
void c1_QRsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_QRsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_QRsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_QRsim_method_dispatcher.\n"
