...
static const char * c10_debug_family_names[4] = { "nargin", "nargout", "omega",
  "fcnomega" };
...
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_emlrt_marshallIn(SFc10_QRsimInstanceStruct *chartInstance,
  const mxArray *c10_fcnomega, const char_T *c10_identifier);
static real_T c10_b_emlrt_marshallIn(SFc10_QRsimInstanceStruct *chartInstance,
...
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_c_emlrt_marshallIn(SFc10_QRsimInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_d_emlrt_marshallIn(SFc10_QRsimInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  real_T *c10_fcnomega;
  c10_fcnomega = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c10_st = NULL;
  c10_st = NULL;
  c10_y = NULL;
  sf_mex_assign(&c10_y, sf_mex_createcellarray(2), FALSE);
  c10_hoistedGlobal = *c10_fcnomega;
  c10_u = c10_hoistedGlobal;
  c10_b_y = NULL;
  sf_mex_assign(&c10_b_y, sf_mex_create("y", &c10_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c10_y, 0, c10_b_y);
  c10_b_hoistedGlobal = chartInstance->c10_is_active_c10_QRsim;
  ...
  const mxArray *c10_st)
{
  ...
  *c10_fcnomega = c10_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c10_u, 0)), "fcnomega");
  chartInstance->c10_is_active_c10_QRsim = c10_d_emlrt_marshallIn(chartInstance,
...
static void sf_c10_QRsim(SFc10_QRsimInstanceStruct *chartInstance)
{
  ...
  real_T c10_fcnomega;
  real_T *c10_b_fcnomega;
  real_T (*c10_b_omega)[4];
  c10_b_fcnomega = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c10_b_omega = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 5U, chartInstance->c10_sfEvent);
  for (c10_i0 = 0; c10_i0 < 4; c10_i0++) {
    _SFD_DATA_RANGE_CHECK((*c10_b_omega)[c10_i0], 0U);
  }

  _SFD_DATA_RANGE_CHECK(*c10_b_fcnomega, 1U);
  chartInstance->c10_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 5U, chartInstance->c10_sfEvent);
  for (c10_i1 = 0; c10_i1 < 4; c10_i1++) {
    c10_omega[c10_i1] = (*c10_b_omega)[c10_i1];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_nargout, 1U, c10_sf_marshallOut,
    c10_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c10_omega, 2U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_fcnomega, 3U, c10_sf_marshallOut,
    c10_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, 3);
  c10_fcnomega = ((c10_omega[1] + c10_omega[3]) - c10_omega[0]) - c10_omega[2];
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  *c10_b_fcnomega = c10_fcnomega;
  ...
  const mxArray *c10_fcnomega, const char_T *c10_identifier)
{
  ...
  c10_y = c10_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c10_fcnomega),
    &c10_thisId);
  sf_mex_destroy(&c10_fcnomega);
  return c10_y;
}
...
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  const mxArray *c10_fcnomega;
  const char_T *c10_identifier;
  emlrtMsgIdentifier c10_thisId;
  real_T c10_y;
  SFc10_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc10_QRsimInstanceStruct *)chartInstanceVoid;
  c10_fcnomega = sf_mex_dup(c10_mxArrayInData);
  ...
  *c10_inData)
{
  ...
  for (c10_i2 = 0; c10_i2 < 4; c10_i2++) {
    c10_b_inData[c10_i2] = (*(real_T (*)[4])c10_inData)[c10_i2];
  }
...
static const mxArray *sf_get_sim_state_info_c10_QRsim(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"fcnomega\",},{M[8],M[0],T\"is_active_c10_QRsim\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c10_omega)[4];
          c10_fcnomega = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c10_omega = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c10_omega);
          _SFD_SET_DATA_VALUE_PTR(1U, c10_fcnomega);
        }
      }
    } else {
