...
static const char * c32_debug_family_names[13] = { "mQ", "g", "mL", "lL", "e3",
  "nargin", "nargout", "varddxL", "dqvec", "qvec", "R", "f", "ddxL" };

/* Function Declarations */
static void initialize_c32_QRsim(SFc32_QRsimInstanceStruct *chartInstance);
static void initialize_params_c32_QRsim(SFc32_QRsimInstanceStruct *chartInstance);
static void enable_c32_QRsim(SFc32_QRsimInstanceStruct *chartInstance);
static void disable_c32_QRsim(SFc32_QRsimInstanceStruct *chartInstance);
static void c32_update_debugger_state_c32_QRsim(SFc32_QRsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c32_QRsim(SFc32_QRsimInstanceStruct
  *chartInstance);
static void set_sim_state_c32_QRsim(SFc32_QRsimInstanceStruct *chartInstance,
  const mxArray *c32_st);
static void finalize_c32_QRsim(SFc32_QRsimInstanceStruct *chartInstance);
static void sf_c32_QRsim(SFc32_QRsimInstanceStruct *chartInstance);
static void c32_chartstep_c32_QRsim(SFc32_QRsimInstanceStruct *chartInstance);
static void initSimStructsc32_QRsim(SFc32_QRsimInstanceStruct *chartInstance);
...
static const mxArray *c32_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static void c32_emlrt_marshallIn(SFc32_QRsimInstanceStruct *chartInstance, const
  mxArray *c32_ddxL, const char_T *c32_identifier, real_T c32_y[3]);
static void c32_b_emlrt_marshallIn(SFc32_QRsimInstanceStruct *chartInstance,
...
static const mxArray *c32_e_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static real_T c32_c_emlrt_marshallIn(SFc32_QRsimInstanceStruct *chartInstance,
...
static void c32_eml_scalar_eg(SFc32_QRsimInstanceStruct *chartInstance);
static real_T c32_dot(SFc32_QRsimInstanceStruct *chartInstance, real_T c32_a[3],
                      real_T c32_b[3]);
static void c32_b_eml_scalar_eg(SFc32_QRsimInstanceStruct *chartInstance);
static const mxArray *c32_f_sf_marshallOut(void *chartInstanceVoid, void
  *c32_inData);
static int32_T c32_d_emlrt_marshallIn(SFc32_QRsimInstanceStruct *chartInstance,
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId);
static void c32_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c32_mxArrayInData, const char_T *c32_varName, void *c32_outData);
static uint8_T c32_e_emlrt_marshallIn(SFc32_QRsimInstanceStruct *chartInstance,
  const mxArray *c32_b_is_active_c32_QRsim, const char_T *c32_identifier);
static uint8_T c32_f_emlrt_marshallIn(SFc32_QRsimInstanceStruct *chartInstance,
  const mxArray *c32_u, const emlrtMsgIdentifier *c32_parentId);
static void init_dsm_address_info(SFc32_QRsimInstanceStruct *chartInstance);
...
static void initialize_c32_QRsim(SFc32_QRsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c32_is_active_c32_QRsim = 0U;
}
  ...
  *chartInstance)
{
  ...
  c32_hoistedGlobal = chartInstance->c32_is_active_c32_QRsim;
  ...
  const mxArray *c32_st)
{
  ...
  chartInstance->c32_is_active_c32_QRsim = c32_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c32_u, 1)), "is_active_c32_QRsim");
  sf_mex_destroy(&c32_u);
  c32_update_debugger_state_c32_QRsim(chartInstance);
...
static void sf_c32_QRsim(SFc32_QRsimInstanceStruct *chartInstance)
{
  ...
  c32_qvec = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 2);
  c32_ddxL = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c32_dqvec = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c32_i3 = 0; c32_i3 < 3; c32_i3++) {
    _SFD_DATA_RANGE_CHECK((*c32_dqvec)[c32_i3], 1U);
  }
  ...
  for (c32_i5 = 0; c32_i5 < 3; c32_i5++) {
    _SFD_DATA_RANGE_CHECK((*c32_qvec)[c32_i5], 3U);
  }
  ...
  chartInstance->c32_sfEvent = CALL_EVENT;
  c32_chartstep_c32_QRsim(chartInstance);
...
static void c32_chartstep_c32_QRsim(SFc32_QRsimInstanceStruct *chartInstance)
{
  ...
  real_T c32_c_a;
  int32_T c32_i17;
  real_T c32_b_dqvec[3];
  int32_T c32_i18;
  real_T c32_c_dqvec[3];
  real_T c32_d_b;
  real_T c32_c_y;
  int32_T c32_i19;
  real_T c32_b_qvec[3];
  ...
  c32_c_qvec = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 2);
  c32_b_ddxL = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c32_d_dqvec = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c32_i8 = 0; c32_i8 < 3; c32_i8++) {
    c32_dqvec[c32_i8] = (*c32_d_dqvec)[c32_i8];
  }

  for (c32_i9 = 0; c32_i9 < 3; c32_i9++) {
    c32_qvec[c32_i9] = (*c32_c_qvec)[c32_i9];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(c32_dqvec, 8U, c32_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c32_qvec, 9U, c32_sf_marshallOut);
  ...
  for (c32_i17 = 0; c32_i17 < 3; c32_i17++) {
    c32_b_dqvec[c32_i17] = c32_dqvec[c32_i17];
  }

  for (c32_i18 = 0; c32_i18 < 3; c32_i18++) {
    c32_c_dqvec[c32_i18] = c32_dqvec[c32_i18];
  }

  c32_d_b = c32_dot(chartInstance, c32_b_dqvec, c32_c_dqvec);
  c32_c_y = c32_c_a * c32_d_b;
  for (c32_i19 = 0; c32_i19 < 3; c32_i19++) {
    c32_b_qvec[c32_i19] = c32_qvec[c32_i19];
  }
  ...
  c32_d_a = -c32_dot(chartInstance, c32_b_qvec, c32_d_y) - c32_c_y;
  for (c32_i21 = 0; c32_i21 < 3; c32_i21++) {
    c32_e_b[c32_i21] = c32_qvec[c32_i21];
  }
  ...
  *c32_inData)
{
  ...
  real_T c32_u[3];
  const mxArray *c32_y = NULL;
  SFc32_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc32_QRsimInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c32_QRsim_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c32_b_is_active_c32_QRsim, const char_T *c32_identifier)
{
  ...
  c32_y = c32_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c32_b_is_active_c32_QRsim), &c32_thisId);
  sf_mex_destroy(&c32_b_is_active_c32_QRsim);
  return c32_y;
}
...
void sf_c32_QRsim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2661502758U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(628264273U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2583002859U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2988353961U);
}

mxArray *sf_c32_QRsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("HsMJffzVhUCgknUkPrPba");
...
mxArray *sf_c32_QRsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c32_QRsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c32_QRsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"ddxL\",},{M[8],M[0],T\"is_active_c32_QRsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c32_QRsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc32_QRsimInstanceStruct *chartInstance;
    chartInstance = (SFc32_QRsimInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,1,1,0,"dqvec");
          _SFD_SET_DATA_PROPS(2,2,0,1,"ddxL");
          _SFD_SET_DATA_PROPS(3,1,1,0,"qvec");
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c32_dqvec);
          _SFD_SET_DATA_VALUE_PTR(2U, *c32_ddxL);
          _SFD_SET_DATA_VALUE_PTR(3U, *c32_qvec);
...
{
  return "3gB0wwUxOwCpskj1T88SwD";
}

static void sf_opaque_initialize_c32_QRsim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc32_QRsimInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c32_QRsim((SFc32_QRsimInstanceStruct*) chartInstanceVar);
  initialize_c32_QRsim((SFc32_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c32_QRsim(void *chartInstanceVar)
{
  enable_c32_QRsim((SFc32_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c32_QRsim(void *chartInstanceVar)
{
  disable_c32_QRsim((SFc32_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c32_QRsim(void *chartInstanceVar)
{
  sf_c32_QRsim((SFc32_QRsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c32_QRsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c32_QRsim((SFc32_QRsimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c32_QRsim();/* state var info */
...
extern void sf_internal_set_sim_state_c32_QRsim(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c32_QRsim((SFc32_QRsimInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c32_QRsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c32_QRsim(S);
}

static void sf_opaque_set_sim_state_c32_QRsim(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c32_QRsim(S, st);
}

static void sf_opaque_terminate_c32_QRsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc32_QRsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QRsim_optimization_info();
    }

    finalize_c32_QRsim((SFc32_QRsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc32_QRsim((SFc32_QRsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c32_QRsim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c32_QRsim((SFc32_QRsimInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c32_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2602474476U));
  ssSetChecksum1(S,(248999734U));
  ssSetChecksum2(S,(288767104U));
  ssSetChecksum3(S,(816776669U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c32_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c32_QRsim(SimStruct *S)
{
  SFc32_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc32_QRsimInstanceStruct *)utMalloc(sizeof
    (SFc32_QRsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc32_QRsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c32_QRsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c32_QRsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c32_QRsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c32_QRsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c32_QRsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c32_QRsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c32_QRsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c32_QRsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c32_QRsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c32_QRsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c32_QRsim;
...
void c32_QRsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c32_QRsim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c32_QRsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c32_QRsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c32_QRsim_method_dispatcher.\n"
