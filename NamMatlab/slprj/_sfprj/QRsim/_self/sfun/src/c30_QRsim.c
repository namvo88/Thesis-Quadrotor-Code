...
static void initialize_c30_QRsim(SFc30_QRsimInstanceStruct *chartInstance);
static void initialize_params_c30_QRsim(SFc30_QRsimInstanceStruct *chartInstance);
static void enable_c30_QRsim(SFc30_QRsimInstanceStruct *chartInstance);
static void disable_c30_QRsim(SFc30_QRsimInstanceStruct *chartInstance);
static void c30_update_debugger_state_c30_QRsim(SFc30_QRsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c30_QRsim(SFc30_QRsimInstanceStruct
  *chartInstance);
static void set_sim_state_c30_QRsim(SFc30_QRsimInstanceStruct *chartInstance,
  const mxArray *c30_st);
static void finalize_c30_QRsim(SFc30_QRsimInstanceStruct *chartInstance);
static void sf_c30_QRsim(SFc30_QRsimInstanceStruct *chartInstance);
static void initSimStructsc30_QRsim(SFc30_QRsimInstanceStruct *chartInstance);
...
static const mxArray *c30_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_emlrt_marshallIn(SFc30_QRsimInstanceStruct *chartInstance, const
  mxArray *c30_fi, const char_T *c30_identifier, real_T c30_y[4]);
static void c30_b_emlrt_marshallIn(SFc30_QRsimInstanceStruct *chartInstance,
...
static const mxArray *c30_d_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static real_T c30_c_emlrt_marshallIn(SFc30_QRsimInstanceStruct *chartInstance,
...
static const mxArray *c30_e_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static void c30_d_emlrt_marshallIn(SFc30_QRsimInstanceStruct *chartInstance,
...
static void c30_realmin(SFc30_QRsimInstanceStruct *chartInstance);
static void c30_eps(SFc30_QRsimInstanceStruct *chartInstance);
static void c30_eml_matlab_zgetrf(SFc30_QRsimInstanceStruct *chartInstance,
  real_T c30_A[16], real_T c30_b_A[16], int32_T c30_ipiv[4], int32_T *c30_info);
static int32_T c30_eml_ixamax(SFc30_QRsimInstanceStruct *chartInstance, int32_T
  c30_n, real_T c30_x[16], int32_T c30_ix0);
static void c30_check_forloop_overflow_error(SFc30_QRsimInstanceStruct
  *chartInstance, boolean_T c30_overflow);
static void c30_eml_xger(SFc30_QRsimInstanceStruct *chartInstance, int32_T c30_m,
  int32_T c30_n, real_T c30_alpha1, int32_T c30_ix0, int32_T c30_iy0, real_T
  c30_A[16], int32_T c30_ia0, real_T c30_b_A[16]);
static void c30_eml_warning(SFc30_QRsimInstanceStruct *chartInstance);
static void c30_eml_xtrsm(SFc30_QRsimInstanceStruct *chartInstance, real_T
  c30_A[16], real_T c30_B[4], real_T c30_b_B[4]);
static void c30_below_threshold(SFc30_QRsimInstanceStruct *chartInstance);
static void c30_eml_scalar_eg(SFc30_QRsimInstanceStruct *chartInstance);
static void c30_b_eml_xtrsm(SFc30_QRsimInstanceStruct *chartInstance, real_T
  c30_A[16], real_T c30_B[4], real_T c30_b_B[4]);
static const mxArray *c30_f_sf_marshallOut(void *chartInstanceVoid, void
  *c30_inData);
static int32_T c30_e_emlrt_marshallIn(SFc30_QRsimInstanceStruct *chartInstance,
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId);
static void c30_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c30_mxArrayInData, const char_T *c30_varName, void *c30_outData);
static uint8_T c30_f_emlrt_marshallIn(SFc30_QRsimInstanceStruct *chartInstance,
  const mxArray *c30_b_is_active_c30_QRsim, const char_T *c30_identifier);
static uint8_T c30_g_emlrt_marshallIn(SFc30_QRsimInstanceStruct *chartInstance,
  const mxArray *c30_u, const emlrtMsgIdentifier *c30_parentId);
static void c30_b_eml_matlab_zgetrf(SFc30_QRsimInstanceStruct *chartInstance,
  real_T c30_A[16], int32_T c30_ipiv[4], int32_T *c30_info);
static void c30_b_eml_xger(SFc30_QRsimInstanceStruct *chartInstance, int32_T
  c30_m, int32_T c30_n, real_T c30_alpha1, int32_T c30_ix0, int32_T c30_iy0,
  real_T c30_A[16], int32_T c30_ia0);
static void c30_c_eml_xtrsm(SFc30_QRsimInstanceStruct *chartInstance, real_T
  c30_A[16], real_T c30_B[4]);
static void c30_d_eml_xtrsm(SFc30_QRsimInstanceStruct *chartInstance, real_T
  c30_A[16], real_T c30_B[4]);
static void init_dsm_address_info(SFc30_QRsimInstanceStruct *chartInstance);
...
static void initialize_c30_QRsim(SFc30_QRsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c30_is_active_c30_QRsim = 0U;
}
  ...
  *chartInstance)
{
  ...
  c30_hoistedGlobal = chartInstance->c30_is_active_c30_QRsim;
  ...
  const mxArray *c30_st)
{
  ...
  chartInstance->c30_is_active_c30_QRsim = c30_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c30_u, 1)), "is_active_c30_QRsim");
  sf_mex_destroy(&c30_u);
  c30_update_debugger_state_c30_QRsim(chartInstance);
...
static void sf_c30_QRsim(SFc30_QRsimInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 18U, chartInstance->c30_sfEvent);
  ...
  chartInstance->c30_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 18U, chartInstance->c30_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 18U, chartInstance->c30_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c30_inData)
{
  ...
  real_T c30_u[4];
  const mxArray *c30_y = NULL;
  SFc30_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc30_QRsimInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c30_QRsim_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c30_b_is_active_c30_QRsim, const char_T *c30_identifier)
{
  ...
  c30_y = c30_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c30_b_is_active_c30_QRsim), &c30_thisId);
  sf_mex_destroy(&c30_b_is_active_c30_QRsim);
  return c30_y;
}
...
void sf_c30_QRsim_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c30_QRsim_get_autoinheritance_info(void)
{
...
mxArray *sf_c30_QRsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c30_QRsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c30_QRsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"fi\",},{M[8],M[0],T\"is_active_c30_QRsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c30_QRsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc30_QRsimInstanceStruct *chartInstance;
    chartInstance = (SFc30_QRsimInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c30_QRsim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc30_QRsimInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c30_QRsim((SFc30_QRsimInstanceStruct*) chartInstanceVar);
  initialize_c30_QRsim((SFc30_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c30_QRsim(void *chartInstanceVar)
{
  enable_c30_QRsim((SFc30_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c30_QRsim(void *chartInstanceVar)
{
  disable_c30_QRsim((SFc30_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c30_QRsim(void *chartInstanceVar)
{
  sf_c30_QRsim((SFc30_QRsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c30_QRsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c30_QRsim((SFc30_QRsimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c30_QRsim();/* state var info */
...
extern void sf_internal_set_sim_state_c30_QRsim(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c30_QRsim((SFc30_QRsimInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c30_QRsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c30_QRsim(S);
}

static void sf_opaque_set_sim_state_c30_QRsim(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c30_QRsim(S, st);
}

static void sf_opaque_terminate_c30_QRsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc30_QRsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QRsim_optimization_info();
    }

    finalize_c30_QRsim((SFc30_QRsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc30_QRsim((SFc30_QRsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c30_QRsim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c30_QRsim((SFc30_QRsimInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c30_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c30_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c30_QRsim(SimStruct *S)
{
  SFc30_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc30_QRsimInstanceStruct *)utMalloc(sizeof
    (SFc30_QRsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc30_QRsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c30_QRsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c30_QRsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c30_QRsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c30_QRsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c30_QRsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c30_QRsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c30_QRsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c30_QRsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c30_QRsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c30_QRsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c30_QRsim;
...
void c30_QRsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c30_QRsim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c30_QRsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c30_QRsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c30_QRsim_method_dispatcher.\n"
