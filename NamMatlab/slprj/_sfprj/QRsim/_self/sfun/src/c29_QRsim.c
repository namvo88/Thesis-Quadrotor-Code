...
static void initialize_c29_QRsim(SFc29_QRsimInstanceStruct *chartInstance);
static void initialize_params_c29_QRsim(SFc29_QRsimInstanceStruct *chartInstance);
static void enable_c29_QRsim(SFc29_QRsimInstanceStruct *chartInstance);
static void disable_c29_QRsim(SFc29_QRsimInstanceStruct *chartInstance);
static void c29_update_debugger_state_c29_QRsim(SFc29_QRsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c29_QRsim(SFc29_QRsimInstanceStruct
  *chartInstance);
static void set_sim_state_c29_QRsim(SFc29_QRsimInstanceStruct *chartInstance,
  const mxArray *c29_st);
static void finalize_c29_QRsim(SFc29_QRsimInstanceStruct *chartInstance);
static void sf_c29_QRsim(SFc29_QRsimInstanceStruct *chartInstance);
static void c29_chartstep_c29_QRsim(SFc29_QRsimInstanceStruct *chartInstance);
static void initSimStructsc29_QRsim(SFc29_QRsimInstanceStruct *chartInstance);
...
static const mxArray *c29_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static void c29_emlrt_marshallIn(SFc29_QRsimInstanceStruct *chartInstance, const
  mxArray *c29_Omegad, const char_T *c29_identifier, real_T c29_y[3]);
static void c29_b_emlrt_marshallIn(SFc29_QRsimInstanceStruct *chartInstance,
...
static const mxArray *c29_c_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static real_T c29_c_emlrt_marshallIn(SFc29_QRsimInstanceStruct *chartInstance,
...
static void c29_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c29_mxArrayInData, const char_T *c29_varName, void *c29_outData);
static void c29_d_emlrt_marshallIn(SFc29_QRsimInstanceStruct *chartInstance,
...
static void c29_eml_scalar_eg(SFc29_QRsimInstanceStruct *chartInstance);
static const mxArray *c29_d_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static int32_T c29_e_emlrt_marshallIn(SFc29_QRsimInstanceStruct *chartInstance,
  const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
static void c29_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c29_mxArrayInData, const char_T *c29_varName, void *c29_outData);
static uint8_T c29_f_emlrt_marshallIn(SFc29_QRsimInstanceStruct *chartInstance,
  const mxArray *c29_b_is_active_c29_QRsim, const char_T *c29_identifier);
static uint8_T c29_g_emlrt_marshallIn(SFc29_QRsimInstanceStruct *chartInstance,
  const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
static void init_dsm_address_info(SFc29_QRsimInstanceStruct *chartInstance);
...
static void initialize_c29_QRsim(SFc29_QRsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c29_is_active_c29_QRsim = 0U;
}
  ...
  *chartInstance)
{
  ...
  c29_hoistedGlobal = chartInstance->c29_is_active_c29_QRsim;
  ...
  const mxArray *c29_st)
{
  ...
  chartInstance->c29_is_active_c29_QRsim = c29_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c29_u, 1)), "is_active_c29_QRsim");
  sf_mex_destroy(&c29_u);
  c29_update_debugger_state_c29_QRsim(chartInstance);
...
static void sf_c29_QRsim(SFc29_QRsimInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 23U, chartInstance->c29_sfEvent);
  ...
  chartInstance->c29_sfEvent = CALL_EVENT;
  c29_chartstep_c29_QRsim(chartInstance);
...
static void c29_chartstep_c29_QRsim(SFc29_QRsimInstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 23U, chartInstance->c29_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 23U, chartInstance->c29_sfEvent);
}
  ...
  *c29_inData)
{
  ...
  real_T c29_u[3];
  const mxArray *c29_y = NULL;
  SFc29_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc29_QRsimInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c29_QRsim_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c29_b_is_active_c29_QRsim, const char_T *c29_identifier)
{
  ...
  c29_y = c29_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c29_b_is_active_c29_QRsim), &c29_thisId);
  sf_mex_destroy(&c29_b_is_active_c29_QRsim);
  return c29_y;
}
...
void sf_c29_QRsim_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c29_QRsim_get_autoinheritance_info(void)
{
...
mxArray *sf_c29_QRsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c29_QRsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c29_QRsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"Omegad\",},{M[8],M[0],T\"is_active_c29_QRsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c29_QRsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc29_QRsimInstanceStruct *chartInstance;
    chartInstance = (SFc29_QRsimInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c29_QRsim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc29_QRsimInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c29_QRsim((SFc29_QRsimInstanceStruct*) chartInstanceVar);
  initialize_c29_QRsim((SFc29_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c29_QRsim(void *chartInstanceVar)
{
  enable_c29_QRsim((SFc29_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c29_QRsim(void *chartInstanceVar)
{
  disable_c29_QRsim((SFc29_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c29_QRsim(void *chartInstanceVar)
{
  sf_c29_QRsim((SFc29_QRsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c29_QRsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c29_QRsim((SFc29_QRsimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c29_QRsim();/* state var info */
...
extern void sf_internal_set_sim_state_c29_QRsim(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c29_QRsim((SFc29_QRsimInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c29_QRsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c29_QRsim(S);
}

static void sf_opaque_set_sim_state_c29_QRsim(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c29_QRsim(S, st);
}

static void sf_opaque_terminate_c29_QRsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc29_QRsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QRsim_optimization_info();
    }

    finalize_c29_QRsim((SFc29_QRsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc29_QRsim((SFc29_QRsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c29_QRsim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c29_QRsim((SFc29_QRsimInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c29_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c29_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c29_QRsim(SimStruct *S)
{
  SFc29_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc29_QRsimInstanceStruct *)utMalloc(sizeof
    (SFc29_QRsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc29_QRsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c29_QRsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c29_QRsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c29_QRsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c29_QRsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c29_QRsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c29_QRsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c29_QRsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c29_QRsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c29_QRsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c29_QRsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c29_QRsim;
...
void c29_QRsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c29_QRsim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c29_QRsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c29_QRsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c29_QRsim_method_dispatcher.\n"
