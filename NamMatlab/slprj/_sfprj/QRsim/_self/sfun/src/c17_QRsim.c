...
static void initialize_c17_QRsim(SFc17_QRsimInstanceStruct *chartInstance);
static void initialize_params_c17_QRsim(SFc17_QRsimInstanceStruct *chartInstance);
static void enable_c17_QRsim(SFc17_QRsimInstanceStruct *chartInstance);
static void disable_c17_QRsim(SFc17_QRsimInstanceStruct *chartInstance);
static void c17_update_debugger_state_c17_QRsim(SFc17_QRsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c17_QRsim(SFc17_QRsimInstanceStruct
  *chartInstance);
static void set_sim_state_c17_QRsim(SFc17_QRsimInstanceStruct *chartInstance,
  const mxArray *c17_st);
static void finalize_c17_QRsim(SFc17_QRsimInstanceStruct *chartInstance);
static void sf_c17_QRsim(SFc17_QRsimInstanceStruct *chartInstance);
static void c17_chartstep_c17_QRsim(SFc17_QRsimInstanceStruct *chartInstance);
static void initSimStructsc17_QRsim(SFc17_QRsimInstanceStruct *chartInstance);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_emlrt_marshallIn(SFc17_QRsimInstanceStruct *chartInstance,
  const mxArray *c17_error, const char_T *c17_identifier);
static real_T c17_b_emlrt_marshallIn(SFc17_QRsimInstanceStruct *chartInstance,
...
static void c17_eml_scalar_eg(SFc17_QRsimInstanceStruct *chartInstance);
static const mxArray *c17_c_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static int32_T c17_c_emlrt_marshallIn(SFc17_QRsimInstanceStruct *chartInstance,
  const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static uint8_T c17_d_emlrt_marshallIn(SFc17_QRsimInstanceStruct *chartInstance,
  const mxArray *c17_b_is_active_c17_QRsim, const char_T *c17_identifier);
static uint8_T c17_e_emlrt_marshallIn(SFc17_QRsimInstanceStruct *chartInstance,
  const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void init_dsm_address_info(SFc17_QRsimInstanceStruct *chartInstance);
...
static void initialize_c17_QRsim(SFc17_QRsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c17_is_active_c17_QRsim = 0U;
}
  ...
  *chartInstance)
{
  ...
  c17_b_hoistedGlobal = chartInstance->c17_is_active_c17_QRsim;
  ...
  const mxArray *c17_st)
{
  ...
  *c17_error = c17_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c17_u, 0)), "error");
  chartInstance->c17_is_active_c17_QRsim = c17_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c17_u, 1)), "is_active_c17_QRsim");
  sf_mex_destroy(&c17_u);
  c17_update_debugger_state_c17_QRsim(chartInstance);
...
static void sf_c17_QRsim(SFc17_QRsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c17_sfEvent = CALL_EVENT;
  c17_chartstep_c17_QRsim(chartInstance);
  ...
  *c17_inData)
{
  ...
  real_T c17_u;
  const mxArray *c17_y = NULL;
  SFc17_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc17_QRsimInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c17_QRsim_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c17_b_is_active_c17_QRsim, const char_T *c17_identifier)
{
  ...
  c17_y = c17_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c17_b_is_active_c17_QRsim), &c17_thisId);
  sf_mex_destroy(&c17_b_is_active_c17_QRsim);
  return c17_y;
}
...
mxArray *sf_c17_QRsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c17_QRsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c17_QRsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"error\",},{M[8],M[0],T\"is_active_c17_QRsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c17_QRsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc17_QRsimInstanceStruct *chartInstance;
    chartInstance = (SFc17_QRsimInstanceStruct *) ((ChartInfoStruct *)
...
{
  chart_debug_initialization(((SFc17_QRsimInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c17_QRsim((SFc17_QRsimInstanceStruct*) chartInstanceVar);
  initialize_c17_QRsim((SFc17_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c17_QRsim(void *chartInstanceVar)
{
  enable_c17_QRsim((SFc17_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c17_QRsim(void *chartInstanceVar)
{
  disable_c17_QRsim((SFc17_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c17_QRsim(void *chartInstanceVar)
{
  sf_c17_QRsim((SFc17_QRsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c17_QRsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c17_QRsim((SFc17_QRsimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c17_QRsim();/* state var info */
...
extern void sf_internal_set_sim_state_c17_QRsim(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c17_QRsim((SFc17_QRsimInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c17_QRsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c17_QRsim(S);
}

static void sf_opaque_set_sim_state_c17_QRsim(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c17_QRsim(S, st);
}

static void sf_opaque_terminate_c17_QRsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc17_QRsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QRsim_optimization_info();
    }

    finalize_c17_QRsim((SFc17_QRsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc17_QRsim((SFc17_QRsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c17_QRsim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c17_QRsim((SFc17_QRsimInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c17_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c17_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c17_QRsim(SimStruct *S)
{
  SFc17_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc17_QRsimInstanceStruct *)utMalloc(sizeof
    (SFc17_QRsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc17_QRsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c17_QRsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c17_QRsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c17_QRsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c17_QRsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c17_QRsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c17_QRsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c17_QRsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c17_QRsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c17_QRsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c17_QRsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c17_QRsim;
...
void c17_QRsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c17_QRsim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c17_QRsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c17_QRsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c17_QRsim_method_dispatcher.\n"
