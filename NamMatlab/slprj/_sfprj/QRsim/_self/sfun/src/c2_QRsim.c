...
static const char * c2_debug_family_names[7] = { "nargin", "nargout", "R", "f",
  "m", "g", "ddr" };
  ...
  *chartInstance)
{
  ...
  real_T (*c2_ddr)[3];
  c2_ddr = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellarray(2), FALSE);
  for (c2_i0 = 0; c2_i0 < 3; c2_i0++) {
    c2_u[c2_i0] = (*c2_ddr)[c2_i0];
  }
  ...
  const mxArray *c2_st)
{
  ...
  c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)), "ddr",
                      c2_dv0);
...
static void sf_c2_QRsim(SFc2_QRsimInstanceStruct *chartInstance)
{
  ...
  c2_m = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  ...
  for (c2_i2 = 0; c2_i2 < 9; c2_i2++) {
    _SFD_DATA_RANGE_CHECK((*c2_R)[c2_i2], 0U);
  }

  for (c2_i3 = 0; c2_i3 < 3; c2_i3++) {
    _SFD_DATA_RANGE_CHECK((*c2_ddr)[c2_i3], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*c2_f, 2U);
...
static void c2_chartstep_c2_QRsim(SFc2_QRsimInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_f, 3U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_m, 4U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_g, 5U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_ddr, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c2_i7 = 0; c2_i7 < 3; c2_i7++) {
    ...
    for (c2_i9 = 0; c2_i9 < 3; c2_i9++) {
      c2_b_y[c2_i7] += c2_b_b[c2_i8 + c2_i7] * c2_c_b[c2_i9];
      c2_i8 += 3;
    }
  }
  ...
  for (c2_i10 = 0; c2_i10 < 3; c2_i10++) {
    c2_A[c2_i10] = c2_dv1[c2_i10] - c2_b_y[c2_i10];
  }
  ...
  for (c2_i11 = 0; c2_i11 < 3; c2_i11++) {
    c2_ddr[c2_i11] = c2_A[c2_i11] / c2_d_y;
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -6);
  _SFD_SYMBOL_SCOPE_POP();
  for (c2_i12 = 0; c2_i12 < 3; c2_i12++) {
    (*c2_b_ddr)[c2_i12] = c2_ddr[c2_i12];
  }
  ...
  mxArray *c2_ddr, const char_T *c2_identifier, real_T c2_y[3])
{
  ...
  c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_ddr), &c2_thisId, c2_y);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mrdivide"), "name", "name", 10);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c2_ddr);
          _SFD_SET_DATA_VALUE_PTR(2U, c2_f);
          _SFD_SET_DATA_VALUE_PTR(3U, c2_m);
