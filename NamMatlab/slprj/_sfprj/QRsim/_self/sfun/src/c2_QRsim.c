...
static const char * c2_debug_family_names[10] = { "l", "ctauf", "Gamma",
<<<<<<< HEAD
  "QRinput", "nargin", "nargout", "var", "f", "M", "fi" };
=======
...
static void c2_emlrt_marshallIn(SFc2_QRsimInstanceStruct *chartInstance, const
  mxArray *c2_fi, const char_T *c2_identifier, real_T c2_y[4]);
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_QRsimInstanceStruct *chartInstance, const
...
static void c2_realmin(SFc2_QRsimInstanceStruct *chartInstance);
static void c2_eps(SFc2_QRsimInstanceStruct *chartInstance);
static void c2_eml_matlab_zgetrf(SFc2_QRsimInstanceStruct *chartInstance, real_T
  c2_A[16], real_T c2_b_A[16], int32_T c2_ipiv[4], int32_T *c2_info);
static int32_T c2_eml_ixamax(SFc2_QRsimInstanceStruct *chartInstance, int32_T
  c2_n, real_T c2_x[16], int32_T c2_ix0);
static void c2_check_forloop_overflow_error(SFc2_QRsimInstanceStruct
  *chartInstance, boolean_T c2_overflow);
static void c2_eml_xger(SFc2_QRsimInstanceStruct *chartInstance, int32_T c2_m,
  int32_T c2_n, real_T c2_alpha1, int32_T c2_ix0, int32_T c2_iy0, real_T c2_A[16],
  int32_T c2_ia0, real_T c2_b_A[16]);
static void c2_eml_warning(SFc2_QRsimInstanceStruct *chartInstance);
static void c2_eml_xtrsm(SFc2_QRsimInstanceStruct *chartInstance, real_T c2_A[16],
  real_T c2_B[4], real_T c2_b_B[4]);
static void c2_below_threshold(SFc2_QRsimInstanceStruct *chartInstance);
static void c2_eml_scalar_eg(SFc2_QRsimInstanceStruct *chartInstance);
static void c2_b_eml_xtrsm(SFc2_QRsimInstanceStruct *chartInstance, real_T c2_A
  [16], real_T c2_B[4], real_T c2_b_B[4]);
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_QRsimInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static uint8_T c2_g_emlrt_marshallIn(SFc2_QRsimInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_eml_matlab_zgetrf(SFc2_QRsimInstanceStruct *chartInstance,
  real_T c2_A[16], int32_T c2_ipiv[4], int32_T *c2_info);
static void c2_b_eml_xger(SFc2_QRsimInstanceStruct *chartInstance, int32_T c2_m,
  int32_T c2_n, real_T c2_alpha1, int32_T c2_ix0, int32_T c2_iy0, real_T c2_A[16],
  int32_T c2_ia0);
static void c2_c_eml_xtrsm(SFc2_QRsimInstanceStruct *chartInstance, real_T c2_A
  [16], real_T c2_B[4]);
static void c2_d_eml_xtrsm(SFc2_QRsimInstanceStruct *chartInstance, real_T c2_A
  [16], real_T c2_B[4]);
  ...
  *chartInstance)
{
  ...
  real_T (*c2_fi)[4];
  c2_fi = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellarray(2), FALSE);
  for (c2_i0 = 0; c2_i0 < 4; c2_i0++) {
    c2_u[c2_i0] = (*c2_fi)[c2_i0];
  }
  ...
  const mxArray *c2_st)
{
  ...
  c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 0)), "fi",
                      c2_dv0);
  for (c2_i1 = 0; c2_i1 < 4; c2_i1++) {
    (*c2_fi)[c2_i1] = c2_dv0[c2_i1];
  }

  chartInstance->c2_is_active_c2_QRsim = c2_f_emlrt_marshallIn(chartInstance,
...
>>>>>>> developErrorAngularVelocity
  ...
  real_T (*c2_b_M)[3];
  real_T (*c2_b_var)[2];
  c2_b_fi = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
<<<<<<< HEAD
  c2_b_M = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 2);
  c2_b_f = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
=======
  c2_b_f = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c2_b_M = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
>>>>>>> developErrorAngularVelocity
  c2_b_var = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  for (c2_i2 = 0; c2_i2 < 2; c2_i2++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_var)[c2_i2], 0U);
  }

<<<<<<< HEAD
  _SFD_DATA_RANGE_CHECK(*c2_b_f, 1U);
  for (c2_i3 = 0; c2_i3 < 3; c2_i3++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_M)[c2_i3], 2U);
  }

=======
  for (c2_i3 = 0; c2_i3 < 3; c2_i3++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_M)[c2_i3], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*c2_b_f, 2U);
>>>>>>> developErrorAngularVelocity
  for (c2_i4 = 0; c2_i4 < 4; c2_i4++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_fi)[c2_i4], 3U);
  }
  ...
  for (c2_i5 = 0; c2_i5 < 2; c2_i5++) {
    c2_var[c2_i5] = (*c2_b_var)[c2_i5];
<<<<<<< HEAD
  }

  c2_f = c2_hoistedGlobal;
  for (c2_i6 = 0; c2_i6 < 3; c2_i6++) {
    c2_M[c2_i6] = (*c2_b_M)[c2_i6];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 10U, 10U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_l, 0U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_ctauf, 1U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
=======
  }
  ...
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 10U, 10U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_l, 0U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_ctauf, 1U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
>>>>>>> developErrorAngularVelocity
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_Gamma, 2U, c2_e_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_QRinput, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
<<<<<<< HEAD
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 5U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_var, 6U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_f, 7U, c2_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_M, 8U, c2_b_sf_marshallOut);
=======
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 5U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_var, 6U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_M, 7U, c2_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_f, 8U, c2_b_sf_marshallOut);
>>>>>>> developErrorAngularVelocity
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_fi, 9U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_Gamma[3] = -c2_ctauf;
  c2_Gamma[7] = c2_ctauf;
  c2_Gamma[11] = -c2_ctauf;
  c2_Gamma[15] = c2_ctauf;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 10);
  c2_QRinput[0] = c2_f;
  for (c2_i9 = 0; c2_i9 < 3; c2_i9++) {
    c2_QRinput[c2_i9 + 1] = c2_M[c2_i9];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 12);
  for (c2_i10 = 0; c2_i10 < 16; c2_i10++) {
    c2_A[c2_i10] = c2_Gamma[c2_i10];
  }

  for (c2_i11 = 0; c2_i11 < 4; c2_i11++) {
    c2_B[c2_i11] = c2_QRinput[c2_i11];
  }
  ...
  for (c2_i = 1; c2_i < 5; c2_i++) {
    ...
    if (c2_ipiv[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      ...
      c2_temp = c2_fi[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
        _SFD_INTEGER_CHECK("", (real_T)c2_b_i), 1, 4, 1, 0) - 1];
      c2_fi[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        (real_T)c2_b_i), 1, 4, 1, 0) - 1] = c2_fi[_SFD_EML_ARRAY_BOUNDS_CHECK("",
  ...
  for (c2_i13 = 0; c2_i13 < 16; c2_i13++) {
    c2_dv1[c2_i13] = c2_A[c2_i13];
  }

  for (c2_i14 = 0; c2_i14 < 16; c2_i14++) {
    c2_dv2[c2_i14] = c2_dv1[c2_i14];
  }

  c2_c_eml_xtrsm(chartInstance, c2_dv2, c2_fi);
  for (c2_i15 = 0; c2_i15 < 16; c2_i15++) {
    c2_dv3[c2_i15] = c2_A[c2_i15];
  }
  ...
  c2_d_eml_xtrsm(chartInstance, c2_dv4, c2_fi);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -12);
  _SFD_SYMBOL_SCOPE_POP();
  for (c2_i17 = 0; c2_i17 < 4; c2_i17++) {
    (*c2_b_fi)[c2_i17] = c2_fi[c2_i17];
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  for (c2_i18 = 0; c2_i18 < 4; c2_i18++) {
    c2_b_inData[c2_i18] = (*(real_T (*)[4])c2_inData)[c2_i18];
  }
  ...
  mxArray *c2_fi, const char_T *c2_identifier, real_T c2_y[4])
{
  ...
  c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_fi), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_fi);
}
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc2_QRsimInstanceStruct *)chartInstanceVoid;
  c2_fi = sf_mex_dup(c2_mxArrayInData);
  ...
  for (c2_i21 = 0; c2_i21 < 4; c2_i21++) {
    (*(real_T (*)[4])c2_outData)[c2_i21] = c2_y[c2_i21];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc2_QRsimInstanceStruct *)chartInstanceVoid;
  c2_Gamma = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_Gamma), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_Gamma);
  c2_i33 = 0;
...
const mxArray *sf_c2_QRsim_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c2_nameCaptureInfo, sf_mex_createstruct("structure", 2, 114, 1),
                FALSE);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 7);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("realmin"), "name", "name", 7);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 14);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("min"), "name", "name", 14);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
                  "resolved", 21);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1366162242U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isa_uint.m"), "resolved",
                  "resolved", 32);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286818784U), "fileTimeLo",
                  "fileTimeLo", 32);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 32);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1323170580U), "fileTimeLo",
                  "fileTimeLo", 33);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 33);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_ixamax.m!below_threshold"),
                  "context", "context", 53);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("length"), "name", "name", 53);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 53);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_ixamax.m"),
                  "context", "context", 56);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_refblas_ixamax"), "name",
                  "name", 56);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 56);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1299076770U), "fileTimeLo",
                  "fileTimeLo", 56);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 56);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xcabs1.m"),
                  "context", "context", 59);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 59);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 59);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
...
static void c2_b_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1363713874U), "fileTimeLo",
                  "fileTimeLo", 64);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 64);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xswap.m"),
                  "context", "context", 67);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_refblas_xswap"), "name",
                  "name", 67);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 67);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1299076786U), "fileTimeLo",
                  "fileTimeLo", 67);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 67);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 74);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_div"), "name", "name", 74);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 74);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1363713872U), "fileTimeLo",
                  "fileTimeLo", 75);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 75);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgeru.m"), "context",
                  "context", 77);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_xger"), "name", "name", 77);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 77);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xger.m!below_threshold"),
                  "context", "context", 80);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("min"), "name", "name", 80);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 80);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xger.m!below_threshold"),
                  "context", "context", 85);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mtimes"), "name", "name", 85);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 85);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xger.m"),
                  "context", "context", 88);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_refblas_xger"), "name",
                  "name", 88);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 88);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1299076776U), "fileTimeLo",
                  "fileTimeLo", 88);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 88);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xger.m"),
                  "context", "context", 89);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_refblas_xgerx"), "name",
                  "name", 89);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 89);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1360282352U), "fileTimeLo",
                  "fileTimeLo", 89);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 89);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1299076778U), "fileTimeLo",
                  "fileTimeLo", 99);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 99);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xtrsm.m!below_threshold"),
                  "context", "context", 101);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mtimes"), "name", "name", 101);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 101);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xtrsm.m"),
                  "context", "context", 104);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_refblas_xtrsm"), "name",
                  "name", 104);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 104);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 112);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("intmin"), "name", "name", 112);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 112);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xtrsm.m"),
                  "context", "context", 113);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_div"), "name", "name", 113);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 113);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
  ...
  *chartInstance, boolean_T c2_overflow)
{
  ...
  if (!c2_overflow) {
    ...
    for (c2_i37 = 0; c2_i37 < 34; c2_i37++) {
      c2_u[c2_i37] = c2_cv0[c2_i37];
    }

    c2_y = NULL;
    sf_mex_assign(&c2_y, sf_mex_create("y", c2_u, 10, 0U, 1U, 0U, 2, 1, 34),
                  FALSE);
    for (c2_i38 = 0; c2_i38 < 23; c2_i38++) {
      c2_b_u[c2_i38] = c2_cv1[c2_i38];
    }
  ...
  const mxArray *c2_b_is_active_c2_QRsim, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_is_active_c2_QRsim),
    &c2_thisId);
  ...
  for (c2_j = 1; c2_j < 4; c2_j++) {
    ...
    for (c2_i48 = 0; c2_i48 < 4; c2_i48++) {
      for (c2_i49 = 0; c2_i49 < 4; c2_i49++) {
        c2_b_A[c2_i49 + c2_i47] = c2_A[c2_i49 + c2_i47];
      }
    ...
    if (c2_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      ...
      for (c2_i = c2_b_jp1j; c2_i <= c2_i50; c2_i++) {
        c2_b_i = c2_i;
    ...
    c2_ia0 = c2_g_c + 5;
    c2_d1 = -1.0;
    c2_b_eml_xger(chartInstance, c2_m, c2_n, c2_d1, c2_d_ix0, c2_d_iy0, c2_A,
                  c2_ia0);
  }
  ...
  if (c2_d_alpha1 == 0.0) {
    ...
    for (c2_j = 1; c2_j <= c2_e_n; c2_j++) {
      ...
      if (c2_yjy != 0.0) {
        ...
        for (c2_ijA = c2_i51; c2_ijA <= c2_i52; c2_ijA++) {
          c2_b_ijA = c2_ijA;
          c2_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
...
{
<<<<<<< HEAD
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2855851461U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3557712840U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3591002720U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(698278103U);
=======
...
mxArray *sf_c2_QRsim_get_autoinheritance_info(void)
{
  ...
  {
<<<<<<< HEAD
    mxArray *mxChecksum = mxCreateString("Guqa1A5ojhbuQIwbZENkrC");
=======
...
static const mxArray *sf_get_sim_state_info_c2_QRsim(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"fi\",},{M[8],M[0],T\"is_active_c2_QRsim\",}}"
  };
...
>>>>>>> developErrorAngularVelocity
...

        {
          ...
          c2_fi = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
<<<<<<< HEAD
          c2_M = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 2);
          c2_f = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c2_var = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c2_var);
          _SFD_SET_DATA_VALUE_PTR(1U, c2_f);
          _SFD_SET_DATA_VALUE_PTR(2U, *c2_M);
=======
          c2_f = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c2_M = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
          c2_var = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c2_var);
          _SFD_SET_DATA_VALUE_PTR(1U, *c2_M);
          _SFD_SET_DATA_VALUE_PTR(2U, c2_f);
>>>>>>> developErrorAngularVelocity
          _SFD_SET_DATA_VALUE_PTR(3U, *c2_fi);
        }
      }
    } else {
...
<<<<<<< HEAD
  ssSetChecksum0(S,(4108996733U));
  ssSetChecksum1(S,(2192334161U));
  ssSetChecksum2(S,(612951481U));
  ssSetChecksum3(S,(3565674175U));
=======
