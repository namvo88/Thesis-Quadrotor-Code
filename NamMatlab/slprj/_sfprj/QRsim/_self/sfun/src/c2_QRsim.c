...
static const char * c2_debug_family_names[7] = { "a", "b", "c", "nargin",
  "nargout", "A", "fcnhat" };
...
static void c2_emlrt_marshallIn(SFc2_QRsimInstanceStruct *chartInstance, const
  mxArray *c2_fcnhat, const char_T *c2_identifier, real_T c2_y[9]);
  ...
  *chartInstance)
{
  ...
  real_T (*c2_fcnhat)[9];
  c2_fcnhat = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellarray(2), FALSE);
  for (c2_i0 = 0; c2_i0 < 9; c2_i0++) {
    c2_u[c2_i0] = (*c2_fcnhat)[c2_i0];
  }
...
static void sf_c2_QRsim(SFc2_QRsimInstanceStruct *chartInstance)
{
  ...
  real_T c2_fcnhat[9];
  int32_T c2_i5;
  real_T (*c2_b_fcnhat)[9];
  real_T (*c2_b_A)[3];
  c2_b_fcnhat = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_b_A = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  for (c2_i2 = 0; c2_i2 < 3; c2_i2++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_A)[c2_i2], 0U);
  }

  for (c2_i3 = 0; c2_i3 < 9; c2_i3++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_fcnhat)[c2_i3], 1U);
  }

  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  for (c2_i4 = 0; c2_i4 < 3; c2_i4++) {
    c2_A[c2_i4] = (*c2_b_A)[c2_i4];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_a, 0U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b, 1U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_c, 2U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 4U, c2_c_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_A, 5U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_fcnhat, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c2_i5 = 0; c2_i5 < 9; c2_i5++) {
    (*c2_b_fcnhat)[c2_i5] = c2_fcnhat[c2_i5];
  }
  ...
  mxArray *c2_fcnhat, const char_T *c2_identifier, real_T c2_y[9])
{
  ...
  c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_fcnhat), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_fcnhat);
}
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc2_QRsimInstanceStruct *)chartInstanceVoid;
  c2_fcnhat = sf_mex_dup(c2_mxArrayInData);
...
static const mxArray *sf_get_sim_state_info_c2_QRsim(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"fcnhat\",},{M[8],M[0],T\"is_active_c2_QRsim\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c2_fcnhat);
        }
      }
    } else {
