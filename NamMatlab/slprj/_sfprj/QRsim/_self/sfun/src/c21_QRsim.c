...
static const char * c21_debug_family_names[5] = { "nargin", "nargout", "Omega",
  "I", "Omegacross" };

/* Function Declarations */
static void initialize_c21_QRsim(SFc21_QRsimInstanceStruct *chartInstance);
static void initialize_params_c21_QRsim(SFc21_QRsimInstanceStruct *chartInstance);
static void enable_c21_QRsim(SFc21_QRsimInstanceStruct *chartInstance);
static void disable_c21_QRsim(SFc21_QRsimInstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_QRsim(SFc21_QRsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c21_QRsim(SFc21_QRsimInstanceStruct
  *chartInstance);
static void set_sim_state_c21_QRsim(SFc21_QRsimInstanceStruct *chartInstance,
  const mxArray *c21_st);
static void finalize_c21_QRsim(SFc21_QRsimInstanceStruct *chartInstance);
static void sf_c21_QRsim(SFc21_QRsimInstanceStruct *chartInstance);
static void c21_chartstep_c21_QRsim(SFc21_QRsimInstanceStruct *chartInstance);
static void initSimStructsc21_QRsim(SFc21_QRsimInstanceStruct *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static void c21_emlrt_marshallIn(SFc21_QRsimInstanceStruct *chartInstance, const
  mxArray *c21_Omegacross, const char_T *c21_identifier, real_T c21_y[3]);
static void c21_b_emlrt_marshallIn(SFc21_QRsimInstanceStruct *chartInstance,
...
static const mxArray *c21_c_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static real_T c21_c_emlrt_marshallIn(SFc21_QRsimInstanceStruct *chartInstance,
...
static void c21_eml_scalar_eg(SFc21_QRsimInstanceStruct *chartInstance);
static const mxArray *c21_d_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static int32_T c21_d_emlrt_marshallIn(SFc21_QRsimInstanceStruct *chartInstance,
  const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData);
static uint8_T c21_e_emlrt_marshallIn(SFc21_QRsimInstanceStruct *chartInstance,
  const mxArray *c21_b_is_active_c21_QRsim, const char_T *c21_identifier);
static uint8_T c21_f_emlrt_marshallIn(SFc21_QRsimInstanceStruct *chartInstance,
  const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void init_dsm_address_info(SFc21_QRsimInstanceStruct *chartInstance);
...
static void initialize_c21_QRsim(SFc21_QRsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_QRsim = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c21_Omegacross)[3];
  c21_Omegacross = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c21_st = NULL;
  c21_st = NULL;
  c21_y = NULL;
  sf_mex_assign(&c21_y, sf_mex_createcellarray(2), FALSE);
  for (c21_i0 = 0; c21_i0 < 3; c21_i0++) {
    c21_u[c21_i0] = (*c21_Omegacross)[c21_i0];
  }

  c21_b_y = NULL;
  sf_mex_assign(&c21_b_y, sf_mex_create("y", c21_u, 0, 0U, 1U, 0U, 1, 3), FALSE);
  sf_mex_setcell(c21_y, 0, c21_b_y);
  c21_hoistedGlobal = chartInstance->c21_is_active_c21_QRsim;
  ...
  const mxArray *c21_st)
{
  ...
  for (c21_i1 = 0; c21_i1 < 3; c21_i1++) {
    (*c21_Omegacross)[c21_i1] = c21_dv0[c21_i1];
  }

  chartInstance->c21_is_active_c21_QRsim = c21_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c21_u, 1)), "is_active_c21_QRsim");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_QRsim(chartInstance);
...
static void sf_c21_QRsim(SFc21_QRsimInstanceStruct *chartInstance)
{
  ...
  real_T (*c21_Omega)[3];
  real_T (*c21_Omegacross)[3];
  c21_I = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c21_i2 = 0; c21_i2 < 3; c21_i2++) {
    _SFD_DATA_RANGE_CHECK((*c21_Omegacross)[c21_i2], 0U);
  }

  for (c21_i3 = 0; c21_i3 < 3; c21_i3++) {
    _SFD_DATA_RANGE_CHECK((*c21_Omega)[c21_i3], 1U);
  }

  for (c21_i4 = 0; c21_i4 < 9; c21_i4++) {
    _SFD_DATA_RANGE_CHECK((*c21_I)[c21_i4], 2U);
  }

  chartInstance->c21_sfEvent = CALL_EVENT;
  c21_chartstep_c21_QRsim(chartInstance);
...
static void c21_chartstep_c21_QRsim(SFc21_QRsimInstanceStruct *chartInstance)
{
  ...
  real_T c21_c3;
  int32_T c21_i13;
  real_T (*c21_b_Omegacross)[3];
  real_T (*c21_b_I)[9];
  real_T (*c21_b_Omega)[3];
  c21_b_I = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
  c21_b_Omega = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  c21_b_Omegacross = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 19U, chartInstance->c21_sfEvent);
  for (c21_i5 = 0; c21_i5 < 3; c21_i5++) {
    c21_Omega[c21_i5] = (*c21_b_Omega)[c21_i5];
  }

  for (c21_i6 = 0; c21_i6 < 9; c21_i6++) {
    c21_I[c21_i6] = (*c21_b_I)[c21_i6];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c21_nargout, 1U, c21_c_sf_marshallOut,
    c21_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c21_Omega, 2U, c21_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c21_I, 3U, c21_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c21_Omegacross, 4U, c21_sf_marshallOut,
    c21_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c21_sfEvent, 3);
  for (c21_i7 = 0; c21_i7 < 9; c21_i7++) {
    c21_a[c21_i7] = c21_I[c21_i7];
  }

  for (c21_i8 = 0; c21_i8 < 3; c21_i8++) {
    c21_b[c21_i8] = c21_Omega[c21_i8];
  }
  ...
  for (c21_i9 = 0; c21_i9 < 3; c21_i9++) {
    ...
    for (c21_i11 = 0; c21_i11 < 3; c21_i11++) {
      c21_y[c21_i9] += c21_a[c21_i10 + c21_i9] * c21_b[c21_i11];
      c21_i10 += 3;
    }
  }

  for (c21_i12 = 0; c21_i12 < 3; c21_i12++) {
    c21_b[c21_i12] = c21_Omega[c21_i12];
  }
  ...
  c21_c1 = c21_b_y - c21_c_y;
  c21_d_a = c21_b[2];
  c21_d_b = c21_y[0];
  c21_d_y = c21_d_a * c21_d_b;
  c21_e_a = c21_b[0];
  c21_e_b = c21_y[2];
  c21_e_y = c21_e_a * c21_e_b;
  c21_c2 = c21_d_y - c21_e_y;
  c21_f_a = c21_b[0];
  c21_f_b = c21_y[1];
  c21_f_y = c21_f_a * c21_f_b;
  c21_g_a = c21_b[1];
  c21_g_b = c21_y[0];
  c21_g_y = c21_g_a * c21_g_b;
  c21_c3 = c21_f_y - c21_g_y;
  c21_Omegacross[0] = c21_c1;
  c21_Omegacross[1] = c21_c2;
  c21_Omegacross[2] = c21_c3;
  _SFD_EML_CALL(0U, chartInstance->c21_sfEvent, -3);
  _SFD_SYMBOL_SCOPE_POP();
  for (c21_i13 = 0; c21_i13 < 3; c21_i13++) {
    (*c21_b_Omegacross)[c21_i13] = c21_Omegacross[c21_i13];
  }
  ...
  *c21_inData)
{
  ...
  real_T c21_u[3];
  const mxArray *c21_y = NULL;
  SFc21_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc21_QRsimInstanceStruct *)chartInstanceVoid;
  c21_mxArrayOutData = NULL;
  for (c21_i14 = 0; c21_i14 < 3; c21_i14++) {
    c21_b_inData[c21_i14] = (*(real_T (*)[3])c21_inData)[c21_i14];
  }

  for (c21_i15 = 0; c21_i15 < 3; c21_i15++) {
    c21_u[c21_i15] = c21_b_inData[c21_i15];
  }
  ...
  mxArray *c21_Omegacross, const char_T *c21_identifier, real_T c21_y[3])
{
  ...
  c21_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c21_Omegacross), &c21_thisId,
    c21_y);
  sf_mex_destroy(&c21_Omegacross);
}
  ...
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData)
{
  ...
  SFc21_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc21_QRsimInstanceStruct *)chartInstanceVoid;
  c21_Omegacross = sf_mex_dup(c21_mxArrayInData);
  ...
  for (c21_i17 = 0; c21_i17 < 3; c21_i17++) {
    (*(real_T (*)[3])c21_outData)[c21_i17] = c21_y[c21_i17];
  }
  ...
  *c21_inData)
{
  ...
  for (c21_i19 = 0; c21_i19 < 3; c21_i19++) {
    for (c21_i20 = 0; c21_i20 < 3; c21_i20++) {
      c21_b_inData[c21_i20 + c21_i18] = (*(real_T (*)[9])c21_inData)[c21_i20 +
        c21_i18];
    }
...
const mxArray *sf_c21_QRsim_get_eml_resolved_functions_info(void)
{
  const mxArray *c21_nameCaptureInfo = NULL;
  c21_nameCaptureInfo = NULL;
  sf_mex_assign(&c21_nameCaptureInfo, sf_mex_createstruct("structure", 2, 12, 1),
                FALSE);
...
static void c21_info_helper(const mxArray **c21_info)
{
  ...
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(1363713878U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(1363713870U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m"), "context",
                  "context", 5);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut("eml_blas_inline"), "name",
                  "name", 5);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(""), "dominantType",
                  "dominantType", 5);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_blas_inline.m"),
                  "resolved", "resolved", 5);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(1299076768U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m!below_threshold"),
                  "context", "context", 6);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut("mtimes"), "name", "name", 6);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"),
                  "context", "context", 9);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut("eml_refblas_xgemm"), "name",
                  "name", 9);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m"),
                  "resolved", "resolved", 9);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(1360282350U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c21_info, sf_mex_duplicatearraysafe(&c21_lhs9), "lhs", "lhs",
                  9);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(""), "context", "context", 10);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut("cross"), "name", "name", 10);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m"), "resolved",
                  "resolved", 10);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(1286818842U), "fileTimeLo",
                  "fileTimeLo", 10);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 10);
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/specfun/cross.m"), "context",
                  "context", 11);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut("mtimes"), "name", "name", 11);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 11);
  sf_mex_addfield(*c21_info, c21_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c21_info, c21_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 11);
  sf_mex_assign(&c21_rhs11, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c21_lhs11, sf_mex_createcellarray(0), FALSE);
  ...
  const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId)
{
  int32_T c21_y;
  int32_T c21_i24;
  sf_mex_import(c21_parentId, sf_mex_dup(c21_u), &c21_i24, 1, 6, 0U, 0, 0U, 0);
  c21_y = c21_i24;
  sf_mex_destroy(&c21_u);
  return c21_y;
}
  ...
  const mxArray *c21_b_is_active_c21_QRsim, const char_T *c21_identifier)
{
  ...
  c21_y = c21_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_QRsim), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_QRsim);
  return c21_y;
}
...
void sf_c21_QRsim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(231568359U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(873953081U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4083318844U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3378648342U);
}

mxArray *sf_c21_QRsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("UqUEHAMv7TUBQBolLx8KAC");
...
mxArray *sf_c21_QRsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c21_QRsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c21_QRsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"Omegacross\",},{M[8],M[0],T\"is_active_c21_QRsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_QRsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc21_QRsimInstanceStruct *chartInstance;
    chartInstance = (SFc21_QRsimInstanceStruct *) ((ChartInfoStruct *)
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,2,0,1,"Omegacross");
...

        {
          ...
          c21_I = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
          c21_Omega = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          c21_Omegacross = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S,
            1);
          _SFD_SET_DATA_VALUE_PTR(0U, *c21_Omegacross);
          _SFD_SET_DATA_VALUE_PTR(1U, *c21_Omega);
          _SFD_SET_DATA_VALUE_PTR(2U, *c21_I);
        }
      }
    } else {
...
{
  return "xc4ZelDwIUNREmwivvnUhF";
}

static void sf_opaque_initialize_c21_QRsim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_QRsimInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c21_QRsim((SFc21_QRsimInstanceStruct*) chartInstanceVar);
  initialize_c21_QRsim((SFc21_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c21_QRsim(void *chartInstanceVar)
{
  enable_c21_QRsim((SFc21_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_QRsim(void *chartInstanceVar)
{
  disable_c21_QRsim((SFc21_QRsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_QRsim(void *chartInstanceVar)
{
  sf_c21_QRsim((SFc21_QRsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c21_QRsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_QRsim((SFc21_QRsimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c21_QRsim();/* state var info */
...
extern void sf_internal_set_sim_state_c21_QRsim(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c21_QRsim((SFc21_QRsimInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c21_QRsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c21_QRsim(S);
}

static void sf_opaque_set_sim_state_c21_QRsim(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c21_QRsim(S, st);
}

static void sf_opaque_terminate_c21_QRsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_QRsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QRsim_optimization_info();
    }

    finalize_c21_QRsim((SFc21_QRsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc21_QRsim((SFc21_QRsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_QRsim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c21_QRsim((SFc21_QRsimInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c21_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2165550808U));
  ssSetChecksum1(S,(2276214537U));
  ssSetChecksum2(S,(3289787017U));
  ssSetChecksum3(S,(1248675757U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c21_QRsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_QRsim(SimStruct *S)
{
  SFc21_QRsimInstanceStruct *chartInstance;
  chartInstance = (SFc21_QRsimInstanceStruct *)utMalloc(sizeof
    (SFc21_QRsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc21_QRsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c21_QRsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c21_QRsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c21_QRsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c21_QRsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c21_QRsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c21_QRsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c21_QRsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c21_QRsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_QRsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_QRsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c21_QRsim;
...
void c21_QRsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_QRsim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_QRsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_QRsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_QRsim_method_dispatcher.\n"
