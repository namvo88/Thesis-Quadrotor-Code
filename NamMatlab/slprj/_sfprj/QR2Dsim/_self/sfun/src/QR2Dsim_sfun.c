  ...
  chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==39) {
    c39_QR2Dsim_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1491630606U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4265409161U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2200562284U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1302638477U);
      ...
      switch (chartFileNumber) {
       ...
       case 39:
        {
          extern void sf_c39_QR2Dsim_get_check_sum(mxArray *plhs[]);
          sf_c39_QR2Dsim_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2256102513U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4132896486U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1159704811U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(32031145U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 32:
      {
        if (strcmp(aiChksum, "iHA0w3wZavwHNmq9Br8MG") == 0) {
     ...
     case 39:
      {
        if (strcmp(aiChksum, "6H0mFqdm2QKQ52YVrSQjqB") == 0) {
          extern mxArray *sf_c39_QR2Dsim_get_autoinheritance_info(void);
          plhs[0] = sf_c39_QR2Dsim_get_autoinheritance_info();
          break;
        }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 39:
      {
        extern const mxArray *sf_c39_QR2Dsim_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c39_QR2Dsim_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 32:
      {
        if (strcmp(tpChksum, "4HuDBy2TI8qk2UD9E6JKCH") == 0) {
     ...
     case 39:
      {
        if (strcmp(tpChksum, "VfNy8WQw6bEnRMjGEbTyYB") == 0) {
          extern mxArray *sf_c39_QR2Dsim_third_party_uses_info(void);
          plhs[0] = sf_c39_QR2Dsim_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 39:
      {
        if (strcmp(tpChksum, "VfNy8WQw6bEnRMjGEbTyYB") == 0) {
          extern mxArray *sf_c39_QR2Dsim_updateBuildInfo_args_info(void);
          plhs[0] = sf_c39_QR2Dsim_updateBuildInfo_args_info();
          break;
        }
      }
