...
static const char * c2_debug_family_names[4] = { "nargin", "nargout", "R",
  "detR" };
...
static real_T c2_emlrt_marshallIn(SFc2_QRLsimInstanceStruct *chartInstance,
  const mxArray *c2_detR, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_QRLsimInstanceStruct *chartInstance,
...
static void c2_realmin(SFc2_QRLsimInstanceStruct *chartInstance);
static void c2_eps(SFc2_QRLsimInstanceStruct *chartInstance);
static void c2_eml_matlab_zgetrf(SFc2_QRLsimInstanceStruct *chartInstance,
  real_T c2_A[9], real_T c2_b_A[9], int32_T c2_ipiv[3], int32_T *c2_info);
static int32_T c2_eml_ixamax(SFc2_QRLsimInstanceStruct *chartInstance, int32_T
  c2_n, real_T c2_x[9], int32_T c2_ix0);
static void c2_check_forloop_overflow_error(SFc2_QRLsimInstanceStruct
  *chartInstance, boolean_T c2_overflow);
static void c2_eml_xger(SFc2_QRLsimInstanceStruct *chartInstance, int32_T c2_m,
  int32_T c2_n, real_T c2_alpha1, int32_T c2_ix0, int32_T c2_iy0, real_T c2_A[9],
  int32_T c2_ia0, real_T c2_b_A[9]);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_QRLsimInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_QRLsimInstanceStruct *chartInstance,
...
static uint8_T c2_e_emlrt_marshallIn(SFc2_QRLsimInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_eml_matlab_zgetrf(SFc2_QRLsimInstanceStruct *chartInstance,
  real_T c2_A[9], int32_T c2_ipiv[3], int32_T *c2_info);
static void c2_b_eml_xger(SFc2_QRLsimInstanceStruct *chartInstance, int32_T c2_m,
  int32_T c2_n, real_T c2_alpha1, int32_T c2_ix0, int32_T c2_iy0, real_T c2_A[9],
  int32_T c2_ia0);
  ...
  *chartInstance)
{
  ...
  real_T *c2_detR;
  c2_detR = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_st = NULL;
  c2_st = NULL;
  c2_y = NULL;
  sf_mex_assign(&c2_y, sf_mex_createcellarray(2), FALSE);
  c2_hoistedGlobal = *c2_detR;
  c2_u = c2_hoistedGlobal;
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", &c2_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c2_y, 0, c2_b_y);
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_QRLsim;
  ...
  const mxArray *c2_st)
{
  ...
  *c2_detR = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    0)), "detR");
  chartInstance->c2_is_active_c2_QRLsim = c2_d_emlrt_marshallIn(chartInstance,
...
static void sf_c2_QRLsim(SFc2_QRLsimInstanceStruct *chartInstance)
{
  ...
  real_T *c2_b_detR;
  real_T (*c2_b_R)[9];
  c2_b_detR = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_b_R = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  for (c2_i0 = 0; c2_i0 < 9; c2_i0++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_R)[c2_i0], 0U);
  }

  _SFD_DATA_RANGE_CHECK(*c2_b_detR, 1U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  for (c2_i1 = 0; c2_i1 < 9; c2_i1++) {
    c2_R[c2_i1] = (*c2_b_R)[c2_i1];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_R, 2U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_detR, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 4);
  for (c2_i2 = 0; c2_i2 < 9; c2_i2++) {
    c2_x[c2_i2] = c2_R[c2_i2];
  }
  ...
  for (c2_k = 0; c2_k < 2; c2_k++) {
    ...
    c2_b = c2_x[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      ...
      _SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("", c2_b_k), 1,
      3, 2, 0) - 1)) - 1];
    c2_detR = c2_a * c2_b;
  }
  ...
  const mxArray *c2_detR, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_detR), &c2_thisId);
  sf_mex_destroy(&c2_detR);
  return c2_y;
}
...
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_detR;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  real_T c2_y;
  SFc2_QRLsimInstanceStruct *chartInstance;
  chartInstance = (SFc2_QRLsimInstanceStruct *)chartInstanceVoid;
  c2_detR = sf_mex_dup(c2_mxArrayInData);
  ...
  *c2_inData)
{
  ...
  for (c2_i4 = 0; c2_i4 < 3; c2_i4++) {
    for (c2_i5 = 0; c2_i5 < 3; c2_i5++) {
      c2_b_inData[c2_i5 + c2_i3] = (*(real_T (*)[9])c2_inData)[c2_i5 + c2_i3];
    }
...
const mxArray *sf_c2_QRLsim_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c2_nameCaptureInfo, sf_mex_createstruct("structure", 2, 98, 1),
                FALSE);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("det"), "name", "name", 0);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 19);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("colon"), "name", "name", 19);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 19);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "context",
                  "context", 20);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("colon"), "name", "name", 20);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!integer_colon_length_nonnegd"),
                  "context", "context", 34);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("intmax"), "name", "name", 34);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_ixamax.m!below_threshold"),
                  "context", "context", 51);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("length"), "name", "name", 51);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xcabs1.m"),
                  "context", "context", 57);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 57);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 57);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
...
static void c2_b_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xswap.m"),
                  "context", "context", 67);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 67);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 72);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_div"), "name", "name", 72);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 72);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgeru.m"), "context",
                  "context", 75);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_xger"), "name", "name", 75);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 75);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xger.m!below_threshold"),
                  "context", "context", 78);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("min"), "name", "name", 78);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 78);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgerx.m"),
                  "context", "context", 89);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 89);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/det.m"), "context",
                  "context", 94);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mtimes"), "name", "name", 94);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 94);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  for (c2_j = 1; c2_j < 3; c2_j++) {
    ...
    for (c2_i16 = 0; c2_i16 < 3; c2_i16++) {
      for (c2_i17 = 0; c2_i17 < 3; c2_i17++) {
        c2_b_A[c2_i17 + c2_i15] = c2_A[c2_i17 + c2_i15];
      }
      ...
      if (c2_jpiv_offset != 0) {
        ...
        for (c2_k = 1; c2_k < 4; c2_k++) {
          ...
          c2_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c2_ix), 1, 9, 1, 0) - 1] = c2_A[_SFD_EML_ARRAY_BOUNDS_CHECK(
            "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c2_iy), 1, 9, 1, 0) - 1];
          c2_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
  ...
  if (c2_d_alpha1 == 0.0) {
    ...
    for (c2_j = 1; c2_j <= c2_e_n; c2_j++) {
      ...
      if (c2_yjy != 0.0) {
        ...
        for (c2_ijA = c2_i19; c2_ijA <= c2_i20; c2_ijA++) {
          c2_b_ijA = c2_ijA;
          c2_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(984393355U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3625293191U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(490106886U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1702069799U);
}
...
mxArray *sf_c2_QRLsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("jXBZygxvoogr6I8uy7nwqF");
...
static const mxArray *sf_get_sim_state_info_c2_QRLsim(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"detR\",},{M[8],M[0],T\"is_active_c2_QRLsim\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c2_R)[9];
          c2_detR = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c2_R = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c2_R);
          _SFD_SET_DATA_VALUE_PTR(1U, c2_detR);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c2_QRLsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2793977100U));
  ssSetChecksum1(S,(2928720166U));
  ssSetChecksum2(S,(2980386794U));
  ssSetChecksum3(S,(396182337U));
