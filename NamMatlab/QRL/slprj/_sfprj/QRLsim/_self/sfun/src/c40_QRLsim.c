...
static void sf_c40_QRLsim(SFc40_QRLsimInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 11U, chartInstance->c40_sfEvent);
...
static void c40_chartstep_c40_QRLsim(SFc40_QRLsimInstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 11U, chartInstance->c40_sfEvent);
  ...
  *c40_b_PsiR = c40_PsiR;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 11U, chartInstance->c40_sfEvent);
}
