...
static const char * c5_debug_family_names[6] = { "qhat", "nargin", "nargout",
  "q", "dq", "OmegaL" };
...
static void c5_chartstep_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance);
static void initSimStructsc5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance, const
  mxArray *c5_OmegaL, const char_T *c5_identifier, real_T c5_y[3]);
static void c5_b_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[3]);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_d_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance,
...
static void c5_eml_scalar_eg(SFc5_QRLsimInstanceStruct *chartInstance);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_e_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_f_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_QRLsim, const char_T *c5_identifier);
static uint8_T c5_g_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
  ...
  const mxArray *c5_st)
{
  ...
  for (c5_i1 = 0; c5_i1 < 3; c5_i1++) {
    (*c5_OmegaL)[c5_i1] = c5_dv0[c5_i1];
  }

  chartInstance->c5_is_active_c5_QRLsim = c5_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 1)), "is_active_c5_QRLsim");
  sf_mex_destroy(&c5_u);
...
static void sf_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance)
{
  ...
  real_T (*c5_OmegaL)[3];
  real_T (*c5_q)[3];
  c5_dq = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  c5_OmegaL = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c5_i2 = 0; c5_i2 < 3; c5_i2++) {
    _SFD_DATA_RANGE_CHECK((*c5_q)[c5_i2], 0U);
  }

  for (c5_i3 = 0; c5_i3 < 3; c5_i3++) {
    _SFD_DATA_RANGE_CHECK((*c5_OmegaL)[c5_i3], 1U);
  }

  for (c5_i4 = 0; c5_i4 < 3; c5_i4++) {
    _SFD_DATA_RANGE_CHECK((*c5_dq)[c5_i4], 2U);
  }

  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_QRLsim(chartInstance);
...
static void c5_chartstep_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance)
{
  ...
  int32_T c5_i17;
  int32_T c5_i18;
  real_T (*c5_b_OmegaL)[3];
  real_T (*c5_b_dq)[3];
  real_T (*c5_b_q)[3];
  c5_b_dq = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  c5_b_OmegaL = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c5_b_q = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  for (c5_i5 = 0; c5_i5 < 3; c5_i5++) {
    c5_q[c5_i5] = (*c5_b_q)[c5_i5];
  }

  for (c5_i6 = 0; c5_i6 < 3; c5_i6++) {
    c5_dq[c5_i6] = (*c5_b_dq)[c5_i6];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c5_debug_family_names,
    c5_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_qhat, 0U, c5_c_sf_marshallOut,
    c5_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_OmegaL, 5U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c5_i7 = 0; c5_i7 < 9; c5_i7++) {
    c5_a[c5_i7] = c5_qhat[c5_i7];
  }

  for (c5_i8 = 0; c5_i8 < 3; c5_i8++) {
    c5_b[c5_i8] = c5_dq[c5_i8];
  }
  ...
  for (c5_i10 = 0; c5_i10 < 3; c5_i10++) {
    c5_OmegaL[c5_i10] = 0.0;
  }

  for (c5_i11 = 0; c5_i11 < 3; c5_i11++) {
    c5_C[c5_i11] = c5_OmegaL[c5_i11];
  }

  for (c5_i12 = 0; c5_i12 < 3; c5_i12++) {
    c5_OmegaL[c5_i12] = c5_C[c5_i12];
  }

  for (c5_i13 = 0; c5_i13 < 3; c5_i13++) {
    c5_C[c5_i13] = c5_OmegaL[c5_i13];
  }

  for (c5_i14 = 0; c5_i14 < 3; c5_i14++) {
    c5_OmegaL[c5_i14] = c5_C[c5_i14];
  }

  for (c5_i15 = 0; c5_i15 < 3; c5_i15++) {
    c5_OmegaL[c5_i15] = 0.0;
    c5_i16 = 0;
    for (c5_i17 = 0; c5_i17 < 3; c5_i17++) {
      c5_OmegaL[c5_i15] += c5_a[c5_i16 + c5_i15] * c5_b[c5_i17];
      c5_i16 += 3;
    }
  }
  ...
  for (c5_i18 = 0; c5_i18 < 3; c5_i18++) {
    (*c5_b_OmegaL)[c5_i18] = c5_OmegaL[c5_i18];
  }
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  for (c5_i19 = 0; c5_i19 < 3; c5_i19++) {
    c5_b_inData[c5_i19] = (*(real_T (*)[3])c5_inData)[c5_i19];
  }
  ...
  mxArray *c5_OmegaL, const char_T *c5_identifier, real_T c5_y[3])
{
  ...
  c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_OmegaL), &c5_thisId, c5_y);
  sf_mex_destroy(&c5_OmegaL);
}
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  SFc5_QRLsimInstanceStruct *chartInstance;
  chartInstance = (SFc5_QRLsimInstanceStruct *)chartInstanceVoid;
  c5_OmegaL = sf_mex_dup(c5_mxArrayInData);
  ...
  for (c5_i22 = 0; c5_i22 < 3; c5_i22++) {
    (*(real_T (*)[3])c5_outData)[c5_i22] = c5_y[c5_i22];
  }
  ...
  *c5_inData)
{
  ...
  for (c5_i24 = 0; c5_i24 < 3; c5_i24++) {
    for (c5_i25 = 0; c5_i25 < 3; c5_i25++) {
      c5_b_inData[c5_i25 + c5_i23] = (*(real_T (*)[9])c5_inData)[c5_i25 + c5_i23];
    }
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  SFc5_QRLsimInstanceStruct *chartInstance;
  chartInstance = (SFc5_QRLsimInstanceStruct *)chartInstanceVoid;
  c5_qhat = sf_mex_dup(c5_mxArrayInData);
  c5_identifier = c5_varName;
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_qhat), &c5_thisId, c5_y);
  sf_mex_destroy(&c5_qhat);
  c5_i30 = 0;
  for (c5_i31 = 0; c5_i31 < 3; c5_i31++) {
    for (c5_i32 = 0; c5_i32 < 3; c5_i32++) {
      (*(real_T (*)[9])c5_outData)[c5_i32 + c5_i30] = c5_y[c5_i32 + c5_i30];
    }
...
static const mxArray *sf_get_sim_state_info_c5_QRLsim(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"OmegaL\",},{M[8],M[0],T\"is_active_c5_QRLsim\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c5_OmegaL);
          _SFD_SET_DATA_VALUE_PTR(2U, *c5_dq);
        }
      }
    } else {
