...
static const char * c5_debug_family_names[6] = { "nargin", "nargout", "R",
  "Rsat", "detR", "detRsat" };

/* Function Declarations */
static void initialize_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance);
static void initialize_params_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance);
static void enable_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance);
static void disable_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_QRLsim(SFc5_QRLsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_QRLsim(SFc5_QRLsimInstanceStruct
  *chartInstance);
static void set_sim_state_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance,
  const mxArray *c5_st);
static void finalize_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance);
static void sf_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance);
static void initSimStructsc5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance,
  const mxArray *c5_detRsat, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance,
...
static real_T c5_det(SFc5_QRLsimInstanceStruct *chartInstance, real_T c5_x[9]);
static void c5_realmin(SFc5_QRLsimInstanceStruct *chartInstance);
static void c5_eps(SFc5_QRLsimInstanceStruct *chartInstance);
static void c5_eml_matlab_zgetrf(SFc5_QRLsimInstanceStruct *chartInstance,
  real_T c5_A[9], real_T c5_b_A[9], int32_T c5_ipiv[3], int32_T *c5_info);
static int32_T c5_eml_ixamax(SFc5_QRLsimInstanceStruct *chartInstance, int32_T
  c5_n, real_T c5_x[9], int32_T c5_ix0);
static void c5_check_forloop_overflow_error(SFc5_QRLsimInstanceStruct
  *chartInstance, boolean_T c5_overflow);
static void c5_eml_xger(SFc5_QRLsimInstanceStruct *chartInstance, int32_T c5_m,
  int32_T c5_n, real_T c5_alpha1, int32_T c5_ix0, int32_T c5_iy0, real_T c5_A[9],
  int32_T c5_ia0, real_T c5_b_A[9]);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_QRLsim, const char_T *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_QRLsimInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_eml_matlab_zgetrf(SFc5_QRLsimInstanceStruct *chartInstance,
  real_T c5_A[9], int32_T c5_ipiv[3], int32_T *c5_info);
static void c5_b_eml_xger(SFc5_QRLsimInstanceStruct *chartInstance, int32_T c5_m,
  int32_T c5_n, real_T c5_alpha1, int32_T c5_ix0, int32_T c5_iy0, real_T c5_A[9],
  int32_T c5_ia0);
static void init_dsm_address_info(SFc5_QRLsimInstanceStruct *chartInstance);
...
static void initialize_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_QRLsim = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T *c5_detR;
  real_T *c5_detRsat;
  c5_detRsat = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c5_detR = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c5_st = NULL;
  c5_st = NULL;
  c5_y = NULL;
  sf_mex_assign(&c5_y, sf_mex_createcellarray(3), FALSE);
  c5_hoistedGlobal = *c5_detR;
  c5_u = c5_hoistedGlobal;
  c5_b_y = NULL;
  sf_mex_assign(&c5_b_y, sf_mex_create("y", &c5_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c5_y, 0, c5_b_y);
  c5_b_hoistedGlobal = *c5_detRsat;
  c5_b_u = c5_b_hoistedGlobal;
  c5_c_y = NULL;
  sf_mex_assign(&c5_c_y, sf_mex_create("y", &c5_b_u, 0, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c5_y, 1, c5_c_y);
  c5_c_hoistedGlobal = chartInstance->c5_is_active_c5_QRLsim;
  ...
  const mxArray *c5_st)
{
  ...
  *c5_detR = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
    0)), "detR");
  *c5_detRsat = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c5_u, 1)), "detRsat");
  chartInstance->c5_is_active_c5_QRLsim = c5_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 2)), "is_active_c5_QRLsim");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_QRLsim(chartInstance);
...
static void sf_c5_QRLsim(SFc5_QRLsimInstanceStruct *chartInstance)
{
  ...
  real_T (*c5_c_Rsat)[9];
  real_T (*c5_c_R)[9];
  c5_b_detRsat = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c5_c_Rsat = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
  c5_b_detR = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c5_c_R = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  for (c5_i0 = 0; c5_i0 < 9; c5_i0++) {
    _SFD_DATA_RANGE_CHECK((*c5_c_R)[c5_i0], 0U);
  }

  _SFD_DATA_RANGE_CHECK(*c5_b_detR, 1U);
  for (c5_i1 = 0; c5_i1 < 9; c5_i1++) {
    _SFD_DATA_RANGE_CHECK((*c5_c_Rsat)[c5_i1], 2U);
  }

  _SFD_DATA_RANGE_CHECK(*c5_b_detRsat, 3U);
  chartInstance->c5_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 4U, chartInstance->c5_sfEvent);
  for (c5_i2 = 0; c5_i2 < 9; c5_i2++) {
    c5_R[c5_i2] = (*c5_c_R)[c5_i2];
  }

  for (c5_i3 = 0; c5_i3 < 9; c5_i3++) {
    c5_Rsat[c5_i3] = (*c5_c_Rsat)[c5_i3];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_Rsat, 3U, c5_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_detR, 4U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_detRsat, 5U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 4);
  for (c5_i4 = 0; c5_i4 < 9; c5_i4++) {
    c5_b_R[c5_i4] = c5_R[c5_i4];
  }

  c5_detR = c5_det(chartInstance, c5_b_R);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 5);
  for (c5_i5 = 0; c5_i5 < 9; c5_i5++) {
    c5_b_Rsat[c5_i5] = c5_Rsat[c5_i5];
  }

  c5_detRsat = c5_det(chartInstance, c5_b_Rsat);
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, -5);
  _SFD_SYMBOL_SCOPE_POP();
  *c5_b_detR = c5_detR;
  *c5_b_detRsat = c5_detRsat;
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u;
  const mxArray *c5_y = NULL;
  SFc5_QRLsimInstanceStruct *chartInstance;
  chartInstance = (SFc5_QRLsimInstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c5_detRsat, const char_T *c5_identifier)
{
  ...
  c5_y = c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_detRsat), &c5_thisId);
  sf_mex_destroy(&c5_detRsat);
  return c5_y;
}
...
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  const mxArray *c5_detRsat;
  const char_T *c5_identifier;
  emlrtMsgIdentifier c5_thisId;
  real_T c5_y;
  SFc5_QRLsimInstanceStruct *chartInstance;
  chartInstance = (SFc5_QRLsimInstanceStruct *)chartInstanceVoid;
  c5_detRsat = sf_mex_dup(c5_mxArrayInData);
...
const mxArray *sf_c5_QRLsim_get_eml_resolved_functions_info(void)
{
  const mxArray *c5_nameCaptureInfo = NULL;
  c5_nameCaptureInfo = NULL;
  sf_mex_assign(&c5_nameCaptureInfo, sf_mex_createstruct("structure", 2, 98, 1),
                FALSE);
...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("det"), "name", "name", 0);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 0);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/det.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1286818822U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1302688994U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 5);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("realmin"), "name", "name", 5);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 12);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("min"), "name", "name", 12);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1358186140U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m"), "resolved",
                  "resolved", 19);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1366162242U), "fileTimeLo",
                  "fileTimeLo", 19);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 19);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!checkrange"),
                  "context", "context", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("intmax"), "name", "name", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_integer_colon_dispatcher"),
                  "context", "context", 28);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("intmin"), "name", "name", 28);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 28);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m!eml_integer_colon_dispatcher"),
                  "context", "context", 29);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("intmax"), "name", "name", 29);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 29);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isa_uint.m"), "resolved",
                  "resolved", 30);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1286818784U), "fileTimeLo",
                  "fileTimeLo", 30);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 30);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1323170580U), "fileTimeLo",
                  "fileTimeLo", 31);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 31);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 39);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("intmax"), "name", "name", 39);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 39);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_ixamax.m"),
                  "context", "context", 54);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_refblas_ixamax"), "name",
                  "name", 54);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 54);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1299076770U), "fileTimeLo",
                  "fileTimeLo", 54);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 54);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1286818706U), "fileTimeLo",
                  "fileTimeLo", 56);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 56);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xcabs1.m"),
                  "context", "context", 57);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("abs"), "name", "name", 57);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 57);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1363713874U), "fileTimeLo",
                  "fileTimeLo", 62);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 62);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void c5_b_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xswap.m"),
                  "context", "context", 65);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_refblas_xswap"), "name",
                  "name", 65);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 65);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1299076786U), "fileTimeLo",
                  "fileTimeLo", 65);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 65);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xswap.m"),
                  "context", "context", 67);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("abs"), "name", "name", 67);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/lapack/matlab/eml_matlab_zgetrf.m"),
                  "context", "context", 72);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_div"), "name", "name", 72);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 72);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1363713872U), "fileTimeLo",
                  "fileTimeLo", 73);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 73);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgeru.m"), "context",
                  "context", 75);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_xger"), "name", "name", 75);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 75);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xger.m!below_threshold"),
                  "context", "context", 77);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("intmax"), "name", "name", 77);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 77);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xger.m!below_threshold"),
                  "context", "context", 78);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("min"), "name", "name", 78);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 78);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m"), "resolved",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 79);
  sf_mex_assign(&c5_rhs79, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs79, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 80);
  sf_mex_assign(&c5_rhs80, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs80, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 81);
  sf_mex_assign(&c5_rhs81, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs81, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 82);
  sf_mex_assign(&c5_rhs82, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs82, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xger.m!below_threshold"),
                  "context", "context", 83);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("mtimes"), "name", "name", 83);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 83);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 83);
  sf_mex_assign(&c5_rhs83, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs83, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 84);
  sf_mex_assign(&c5_rhs84, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs84, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 85);
  sf_mex_assign(&c5_rhs85, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs85, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xger.m"),
                  "context", "context", 86);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_refblas_xger"), "name",
                  "name", 86);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 86);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1299076776U), "fileTimeLo",
                  "fileTimeLo", 86);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 86);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 86);
  sf_mex_assign(&c5_rhs86, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs86, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xger.m"),
                  "context", "context", 87);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_refblas_xgerx"), "name",
                  "name", 87);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 87);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1360282352U), "fileTimeLo",
                  "fileTimeLo", 87);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 87);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 87);
  sf_mex_assign(&c5_rhs87, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs87, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 88);
  sf_mex_assign(&c5_rhs88, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs88, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgerx.m"),
                  "context", "context", 89);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("abs"), "name", "name", 89);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("coder.internal.indexInt"),
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 89);
  sf_mex_assign(&c5_rhs89, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs89, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 90);
  sf_mex_assign(&c5_rhs90, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs90, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 91);
  sf_mex_assign(&c5_rhs91, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs91, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 92);
  sf_mex_assign(&c5_rhs92, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs92, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 93);
  sf_mex_assign(&c5_rhs93, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs93, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/det.m"), "context",
                  "context", 94);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("mtimes"), "name", "name", 94);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 94);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 94);
  sf_mex_assign(&c5_rhs94, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs94, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 95);
  sf_mex_assign(&c5_rhs95, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs95, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 96);
  sf_mex_assign(&c5_rhs96, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs96, sf_mex_createcellarray(0), FALSE);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/indexIntRelop.m!is_signed_indexIntClass"),
                  "context", "context", 97);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("intmin"), "name", "name", 97);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 97);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmin.m"), "resolved",
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 97);
  sf_mex_assign(&c5_rhs97, sf_mex_createcellarray(0), FALSE);
  sf_mex_assign(&c5_lhs97, sf_mex_createcellarray(0), FALSE);
...
static real_T c5_det(SFc5_QRLsimInstanceStruct *chartInstance, real_T c5_x[9])
{
  ...
  for (c5_k = 0; c5_k < 2; c5_k++) {
    ...
    c5_a = c5_y;
    c5_b = c5_x[((int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", c5_b_k), 1, 3, 1, 0) + 3 * ((int32_T)(real_T)
      _SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("", c5_b_k), 1,
      3, 2, 0) - 1)) - 1];
    c5_y = c5_a * c5_b;
  }
  ...
  for (c5_c_k = 0; c5_c_k < 2; c5_c_k++) {
    ...
    c5_b_a = c5_ipiv[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", c5_b_k), 1, 3, 1, 0) - 1];
    c5_b_b = c5_b_k;
    c5_c_a = c5_b_a;
    c5_c_b = c5_b_b;
    c5_idx = c5_c_a;
    ...
    if (c5_c_n > 1) {
      ...
      for (c5_k = 2; c5_k <= c5_d_n; c5_k++) {
        ...
        c5_g_x = c5_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)c5_ix), 1, 9, 1, 0) - 1];
        c5_h_x = c5_g_x;
        c5_i_x = c5_h_x;
  ...
  const mxArray *c5_b_is_active_c5_QRLsim, const char_T *c5_identifier)
{
  ...
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_QRLsim), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_QRLsim);
  return c5_y;
}
  ...
  real_T c5_A[9], int32_T c5_ipiv[3], int32_T *c5_info)
{
  ...
  *c5_info = 0;
  for (c5_j = 1; c5_j < 3; c5_j++) {
      ...
      if (c5_jpiv_offset != 0) {
        ...
        for (c5_k = 1; c5_k < 4; c5_k++) {
          ...
          c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c5_ix), 1, 9, 1, 0) - 1] = c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK(
            "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c5_iy), 1, 9, 1, 0) - 1];
          c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c5_iy), 1, 9, 1, 0) - 1] = c5_temp;
          c5_i_a = c5_ix + 3;
          c5_ix = c5_i_a;
          c5_j_a = c5_iy + 3;
          c5_iy = c5_j_a;
    ...
    c5_ia0 = c5_g_c + 4;
    c5_d1 = -1.0;
    c5_b_eml_xger(chartInstance, c5_m, c5_n, c5_d1, c5_d_ix0, c5_d_iy0, c5_A,
                  c5_ia0);
  }
  ...
  if (c5_d_alpha1 == 0.0) {
    ...
    for (c5_j = 1; c5_j <= c5_e_n; c5_j++) {
      ...
      if (c5_yjy != 0.0) {
        ...
        for (c5_ijA = c5_i22; c5_ijA <= c5_i23; c5_ijA++) {
          c5_b_ijA = c5_ijA;
          c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c5_b_ijA), 1, 9, 1, 0) - 1] =
            c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c5_b_ijA), 1, 9, 1, 0) - 1] +
            c5_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c5_ix), 1, 9, 1, 0) - 1] * c5_temp;
          c5_e_a = c5_ix + 1;
          c5_ix = c5_e_a;
        }
      }
...
void sf_c5_QRLsim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2536616173U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1494598059U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3314304795U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1143990714U);
}

mxArray *sf_c5_QRLsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("QO3uZNZxxuUMTcU41ezIID");
...
mxArray *sf_c5_QRLsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_QRLsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_QRLsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"detR\",},{M[1],M[7],T\"detRsat\",},{M[8],M[0],T\"is_active_c5_QRLsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_QRLsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_QRLsimInstanceStruct *chartInstance;
    chartInstance = (SFc5_QRLsimInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"detR");
          _SFD_SET_DATA_PROPS(2,1,1,0,"Rsat");
          _SFD_SET_DATA_PROPS(3,2,0,1,"detRsat");
...

        {
          ...
          real_T (*c5_Rsat)[9];
          c5_detRsat = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c5_Rsat = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
          c5_detR = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c5_R = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c5_R);
          _SFD_SET_DATA_VALUE_PTR(1U, c5_detR);
          _SFD_SET_DATA_VALUE_PTR(2U, *c5_Rsat);
          _SFD_SET_DATA_VALUE_PTR(3U, c5_detRsat);
        }
      }
    } else {
...
{
  return "Wqf9b3zIofah56QjL0JzVH";
}

static void sf_opaque_initialize_c5_QRLsim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_QRLsimInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c5_QRLsim((SFc5_QRLsimInstanceStruct*) chartInstanceVar);
  initialize_c5_QRLsim((SFc5_QRLsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_QRLsim(void *chartInstanceVar)
{
  enable_c5_QRLsim((SFc5_QRLsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_QRLsim(void *chartInstanceVar)
{
  disable_c5_QRLsim((SFc5_QRLsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_QRLsim(void *chartInstanceVar)
{
  sf_c5_QRLsim((SFc5_QRLsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_QRLsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_QRLsim((SFc5_QRLsimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_QRLsim();/* state var info */
...
extern void sf_internal_set_sim_state_c5_QRLsim(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_QRLsim((SFc5_QRLsimInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_QRLsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_QRLsim(S);
}

static void sf_opaque_set_sim_state_c5_QRLsim(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_QRLsim(S, st);
}

static void sf_opaque_terminate_c5_QRLsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_QRLsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QRLsim_optimization_info();
    }

    finalize_c5_QRLsim((SFc5_QRLsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_QRLsim((SFc5_QRLsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_QRLsim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_QRLsim((SFc5_QRLsimInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_QRLsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1093211844U));
  ssSetChecksum1(S,(1366322849U));
  ssSetChecksum2(S,(1558872721U));
  ssSetChecksum3(S,(2596251852U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_QRLsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_QRLsim(SimStruct *S)
{
  SFc5_QRLsimInstanceStruct *chartInstance;
  chartInstance = (SFc5_QRLsimInstanceStruct *)utMalloc(sizeof
    (SFc5_QRLsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_QRLsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_QRLsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_QRLsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_QRLsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_QRLsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_QRLsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_QRLsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_QRLsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_QRLsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_QRLsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_QRLsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_QRLsim;
...
void c5_QRLsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_QRLsim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_QRLsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_QRLsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_QRLsim_method_dispatcher.\n"
