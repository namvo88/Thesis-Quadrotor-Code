...
static void sf_c32_QRLsim(SFc32_QRLsimInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 9U, chartInstance->c32_sfEvent);
...
static void c32_chartstep_c32_QRLsim(SFc32_QRLsimInstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 9U, chartInstance->c32_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 9U, chartInstance->c32_sfEvent);
}
