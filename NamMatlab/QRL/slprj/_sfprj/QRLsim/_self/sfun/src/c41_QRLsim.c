...
static const char * c41_debug_family_names[7] = { "b1c", "b2c", "nargin",
  "nargout", "b1d", "b3c", "Rc" };
...
static const mxArray *c41_c_sf_marshallOut(void *chartInstanceVoid, void
  *c41_inData);
static real_T c41_c_emlrt_marshallIn(SFc41_QRLsimInstanceStruct *chartInstance,
...
static const mxArray *c41_e_sf_marshallOut(void *chartInstanceVoid, void
  *c41_inData);
static int32_T c41_e_emlrt_marshallIn(SFc41_QRLsimInstanceStruct *chartInstance,
  const mxArray *c41_u, const emlrtMsgIdentifier *c41_parentId);
static void c41_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c41_mxArrayInData, const char_T *c41_varName, void *c41_outData);
static uint8_T c41_f_emlrt_marshallIn(SFc41_QRLsimInstanceStruct *chartInstance,
  ...
  const mxArray *c41_st)
{
  ...
  for (c41_i1 = 0; c41_i1 < 9; c41_i1++) {
    (*c41_Rc)[c41_i1] = c41_dv0[c41_i1];
  }

  chartInstance->c41_is_active_c41_QRLsim = c41_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c41_u, 1)), "is_active_c41_QRLsim");
...
static void sf_c41_QRLsim(SFc41_QRLsimInstanceStruct *chartInstance)
{
  ...
  for (c41_i2 = 0; c41_i2 < 3; c41_i2++) {
    _SFD_DATA_RANGE_CHECK((*c41_b1d)[c41_i2], 0U);
  }

  for (c41_i3 = 0; c41_i3 < 9; c41_i3++) {
    _SFD_DATA_RANGE_CHECK((*c41_Rc)[c41_i3], 1U);
  }

  for (c41_i4 = 0; c41_i4 < 3; c41_i4++) {
    _SFD_DATA_RANGE_CHECK((*c41_b3c)[c41_i4], 2U);
  }
...
static void c41_chartstep_c41_QRLsim(SFc41_QRLsimInstanceStruct *chartInstance)
{
  ...
  for (c41_i5 = 0; c41_i5 < 3; c41_i5++) {
    c41_b1d[c41_i5] = (*c41_d_b1d)[c41_i5];
  }

  for (c41_i6 = 0; c41_i6 < 3; c41_i6++) {
    c41_b3c[c41_i6] = (*c41_f_b3c)[c41_i6];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 7U, 7U, c41_debug_family_names,
    c41_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c41_b1c, 0U, c41_d_sf_marshallOut,
    c41_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c41_b2c, 1U, c41_d_sf_marshallOut,
    c41_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c41_nargin, 2U, c41_c_sf_marshallOut,
    c41_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c41_nargout, 3U, c41_c_sf_marshallOut,
    c41_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c41_b1d, 4U, c41_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c41_b3c, 5U, c41_b_sf_marshallOut);
  ...
  for (c41_i7 = 0; c41_i7 < 3; c41_i7++) {
    c41_b_b3c[c41_i7] = c41_b3c[c41_i7];
  }

  for (c41_i8 = 0; c41_i8 < 3; c41_i8++) {
    c41_b_b1d[c41_i8] = c41_b1d[c41_i8];
  }
  ...
  for (c41_i14 = 0; c41_i14 < 3; c41_i14++) {
    c41_b1c[c41_i14] = c41_x[c41_i14] / c41_c_y;
  }

  _SFD_EML_CALL(0U, chartInstance->c41_sfEvent, 5);
  for (c41_i15 = 0; c41_i15 < 3; c41_i15++) {
    c41_e_b3c[c41_i15] = c41_b3c[c41_i15];
  }

  for (c41_i16 = 0; c41_i16 < 3; c41_i16++) {
    c41_b_b1c[c41_i16] = c41_b1c[c41_i16];
  }

  c41_cross(chartInstance, c41_e_b3c, c41_b_b1c, c41_dv1);
  for (c41_i17 = 0; c41_i17 < 3; c41_i17++) {
    c41_b2c[c41_i17] = c41_dv1[c41_i17];
  }

  _SFD_EML_CALL(0U, chartInstance->c41_sfEvent, 6);
  for (c41_i18 = 0; c41_i18 < 3; c41_i18++) {
    c41_Rc[c41_i18] = c41_b1c[c41_i18];
  }

  for (c41_i19 = 0; c41_i19 < 3; c41_i19++) {
    c41_Rc[c41_i19 + 3] = c41_b2c[c41_i19];
  }

  for (c41_i20 = 0; c41_i20 < 3; c41_i20++) {
    c41_Rc[c41_i20 + 6] = c41_b3c[c41_i20];
  }

  _SFD_EML_CALL(0U, chartInstance->c41_sfEvent, -6);
  _SFD_SYMBOL_SCOPE_POP();
  for (c41_i21 = 0; c41_i21 < 9; c41_i21++) {
    (*c41_b_Rc)[c41_i21] = c41_Rc[c41_i21];
  }
  ...
  *c41_inData)
{
  ...
  for (c41_i23 = 0; c41_i23 < 3; c41_i23++) {
    for (c41_i24 = 0; c41_i24 < 3; c41_i24++) {
      c41_b_inData[c41_i24 + c41_i22] = (*(real_T (*)[9])c41_inData)[c41_i24 +
        c41_i22];
    }
  ...
  for (c41_i26 = 0; c41_i26 < 3; c41_i26++) {
    for (c41_i27 = 0; c41_i27 < 3; c41_i27++) {
      c41_u[c41_i27 + c41_i25] = c41_b_inData[c41_i27 + c41_i25];
    }
  ...
  const mxArray *c41_u, const emlrtMsgIdentifier *c41_parentId, real_T c41_y[9])
{
  real_T c41_dv2[9];
  int32_T c41_i28;
  sf_mex_import(c41_parentId, sf_mex_dup(c41_u), c41_dv2, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c41_i28 = 0; c41_i28 < 9; c41_i28++) {
    c41_y[c41_i28] = c41_dv2[c41_i28];
  }
  ...
  *c41_mxArrayInData, const char_T *c41_varName, void *c41_outData)
{
  ...
  for (c41_i30 = 0; c41_i30 < 3; c41_i30++) {
    for (c41_i31 = 0; c41_i31 < 3; c41_i31++) {
      (*(real_T (*)[9])c41_outData)[c41_i31 + c41_i29] = c41_y[c41_i31 + c41_i29];
    }
  ...
  *c41_inData)
{
  ...
  for (c41_i32 = 0; c41_i32 < 3; c41_i32++) {
    c41_b_inData[c41_i32] = (*(real_T (*)[3])c41_inData)[c41_i32];
  }

  for (c41_i33 = 0; c41_i33 < 3; c41_i33++) {
    c41_u[c41_i33] = c41_b_inData[c41_i33];
  }
  ...
  *c41_inData)
{
  ...
  for (c41_i34 = 0; c41_i34 < 3; c41_i34++) {
    c41_b_inData[c41_i34] = (*(real_T (*)[3])c41_inData)[c41_i34];
  }

  for (c41_i35 = 0; c41_i35 < 3; c41_i35++) {
    c41_u[c41_i35] = c41_b_inData[c41_i35];
  }
  ...
  *c41_mxArrayInData, const char_T *c41_varName, void *c41_outData)
{
  ...
  for (c41_i37 = 0; c41_i37 < 3; c41_i37++) {
    (*(real_T (*)[3])c41_outData)[c41_i37] = c41_y[c41_i37];
  }
  ...
  const mxArray *c41_u, const emlrtMsgIdentifier *c41_parentId)
{
  int32_T c41_y;
  int32_T c41_i38;
  sf_mex_import(c41_parentId, sf_mex_dup(c41_u), &c41_i38, 1, 6, 0U, 0, 0U, 0);
  c41_y = c41_i38;
  sf_mex_destroy(&c41_u);
  return c41_y;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(723054197U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3273301382U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3807737673U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1006624091U);
}
...
mxArray *sf_c41_QRLsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("HSZc3G1X6TFAnwkQMCjzzG");
...
static const mxArray *sf_get_sim_state_info_c41_QRLsim(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Rc\",},{M[8],M[0],T\"is_active_c41_QRLsim\",}}"
  };
...
static void mdlSetWorkWidths_c41_QRLsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(495019884U));
  ssSetChecksum1(S,(1305151940U));
  ssSetChecksum2(S,(1462429371U));
  ssSetChecksum3(S,(3445087205U));
