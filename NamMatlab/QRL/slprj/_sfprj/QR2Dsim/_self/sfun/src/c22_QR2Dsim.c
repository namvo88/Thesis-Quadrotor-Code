...
static void initialize_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct *chartInstance);
static void initialize_params_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct
  *chartInstance);
static void enable_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct *chartInstance);
static void disable_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct *chartInstance);
static void c22_update_debugger_state_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct
  *chartInstance);
static void set_sim_state_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c22_st);
static void finalize_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct *chartInstance);
static void sf_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct *chartInstance);
static void c22_chartstep_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct *chartInstance);
static void initSimStructsc22_QR2Dsim(SFc22_QR2DsimInstanceStruct *chartInstance);
...
static const mxArray *c22_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static void c22_emlrt_marshallIn(SFc22_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c22_Rc, const char_T *c22_identifier, real_T c22_y[9]);
static void c22_b_emlrt_marshallIn(SFc22_QR2DsimInstanceStruct *chartInstance,
...
static const mxArray *c22_b_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static void c22_c_emlrt_marshallIn(SFc22_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c22_b2c, const char_T *c22_identifier, real_T c22_y[3]);
static void c22_d_emlrt_marshallIn(SFc22_QR2DsimInstanceStruct *chartInstance,
...
static const mxArray *c22_d_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static real_T c22_e_emlrt_marshallIn(SFc22_QR2DsimInstanceStruct *chartInstance,
...
static void c22_cross(SFc22_QR2DsimInstanceStruct *chartInstance, real_T c22_a[3],
                      real_T c22_b[3], real_T c22_c[3]);
static const mxArray *c22_e_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static int32_T c22_f_emlrt_marshallIn(SFc22_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void c22_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c22_mxArrayInData, const char_T *c22_varName, void *c22_outData);
static uint8_T c22_g_emlrt_marshallIn(SFc22_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c22_b_is_active_c22_QR2Dsim, const char_T *c22_identifier);
static uint8_T c22_h_emlrt_marshallIn(SFc22_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void init_dsm_address_info(SFc22_QR2DsimInstanceStruct *chartInstance);
...
static void initialize_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c22_is_active_c22_QR2Dsim = 0U;
}
  ...
  *chartInstance)
{
  ...
  c22_hoistedGlobal = chartInstance->c22_is_active_c22_QR2Dsim;
  ...
  const mxArray *c22_st)
{
  ...
  chartInstance->c22_is_active_c22_QR2Dsim = c22_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c22_u, 3)),
     "is_active_c22_QR2Dsim");
  sf_mex_destroy(&c22_u);
  c22_update_debugger_state_c22_QR2Dsim(chartInstance);
...
static void sf_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 10U, chartInstance->c22_sfEvent);
  ...
  chartInstance->c22_sfEvent = CALL_EVENT;
  c22_chartstep_c22_QR2Dsim(chartInstance);
...
static void c22_chartstep_c22_QR2Dsim(SFc22_QR2DsimInstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 10U, chartInstance->c22_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 10U, chartInstance->c22_sfEvent);
}
  ...
  *c22_inData)
{
  ...
  real_T c22_u[9];
  const mxArray *c22_y = NULL;
  SFc22_QR2DsimInstanceStruct *chartInstance;
  chartInstance = (SFc22_QR2DsimInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c22_QR2Dsim_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c22_b_is_active_c22_QR2Dsim, const char_T *c22_identifier)
{
  ...
  c22_y = c22_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c22_b_is_active_c22_QR2Dsim), &c22_thisId);
  sf_mex_destroy(&c22_b_is_active_c22_QR2Dsim);
  return c22_y;
}
...
void sf_c22_QR2Dsim_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c22_QR2Dsim_get_autoinheritance_info(void)
{
...
mxArray *sf_c22_QR2Dsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c22_QR2Dsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c22_QR2Dsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"Rc\",},{M[1],M[7],T\"b1c\",},{M[1],M[8],T\"b2c\",},{M[8],M[0],T\"is_active_c22_QR2Dsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c22_QR2Dsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc22_QR2DsimInstanceStruct *chartInstance;
    chartInstance = (SFc22_QR2DsimInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c22_QR2Dsim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc22_QR2DsimInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c22_QR2Dsim((SFc22_QR2DsimInstanceStruct*) chartInstanceVar);
  initialize_c22_QR2Dsim((SFc22_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c22_QR2Dsim(void *chartInstanceVar)
{
  enable_c22_QR2Dsim((SFc22_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c22_QR2Dsim(void *chartInstanceVar)
{
  disable_c22_QR2Dsim((SFc22_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c22_QR2Dsim(void *chartInstanceVar)
{
  sf_c22_QR2Dsim((SFc22_QR2DsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c22_QR2Dsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c22_QR2Dsim((SFc22_QR2DsimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c22_QR2Dsim();/* state var info */
...
extern void sf_internal_set_sim_state_c22_QR2Dsim(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c22_QR2Dsim((SFc22_QR2DsimInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c22_QR2Dsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c22_QR2Dsim(S);
}

static void sf_opaque_set_sim_state_c22_QR2Dsim(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c22_QR2Dsim(S, st);
}

static void sf_opaque_terminate_c22_QR2Dsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc22_QR2DsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QR2Dsim_optimization_info();
    }

    finalize_c22_QR2Dsim((SFc22_QR2DsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc22_QR2Dsim((SFc22_QR2DsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c22_QR2Dsim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c22_QR2Dsim((SFc22_QR2DsimInstanceStruct*)
      (((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c22_QR2Dsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c22_QR2Dsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c22_QR2Dsim(SimStruct *S)
{
  SFc22_QR2DsimInstanceStruct *chartInstance;
  chartInstance = (SFc22_QR2DsimInstanceStruct *)utMalloc(sizeof
    (SFc22_QR2DsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc22_QR2DsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c22_QR2Dsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c22_QR2Dsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c22_QR2Dsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c22_QR2Dsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c22_QR2Dsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c22_QR2Dsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c22_QR2Dsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c22_QR2Dsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c22_QR2Dsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c22_QR2Dsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c22_QR2Dsim;
...
void c22_QR2Dsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c22_QR2Dsim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c22_QR2Dsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c22_QR2Dsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c22_QR2Dsim_method_dispatcher.\n"
