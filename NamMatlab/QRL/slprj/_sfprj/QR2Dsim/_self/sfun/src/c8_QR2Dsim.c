...
static void initialize_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct *chartInstance);
static void initialize_params_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct
  *chartInstance);
static void enable_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct *chartInstance);
static void disable_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct
  *chartInstance);
static void set_sim_state_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c8_st);
static void finalize_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct *chartInstance);
static void sf_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct *chartInstance);
static void c8_chartstep_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct *chartInstance);
static void initSimStructsc8_QR2Dsim(SFc8_QR2DsimInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_QR2DsimInstanceStruct *chartInstance, const
  mxArray *c8_eR, const char_T *c8_identifier, real_T c8_y[3]);
static void c8_b_emlrt_marshallIn(SFc8_QR2DsimInstanceStruct *chartInstance,
...
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static void c8_d_emlrt_marshallIn(SFc8_QR2DsimInstanceStruct *chartInstance,
...
static void c8_eml_scalar_eg(SFc8_QR2DsimInstanceStruct *chartInstance);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_e_emlrt_marshallIn(SFc8_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c8_b_is_active_c8_QR2Dsim, const char_T *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_QR2DsimInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_QR2DsimInstanceStruct *chartInstance);
...
static void initialize_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_QR2Dsim = 0U;
}
  ...
  *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_QR2Dsim;
  ...
  const mxArray *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_QR2Dsim = c8_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 1)), "is_active_c8_QR2Dsim");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_QR2Dsim(chartInstance);
...
static void sf_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_QR2Dsim(chartInstance);
...
static void c8_chartstep_c8_QR2Dsim(SFc8_QR2DsimInstanceStruct *chartInstance)
{
  ...
  for (c8_i27 = 0; c8_i27 < 9; c8_i27++) {
    c8_eRhat[c8_i27] = c8_y[c8_i27] - c8_b_y[c8_i27];
  }
  ...
  for (c8_i28 = 0; c8_i28 < 3; c8_i28++) {
    c8_eR[c8_i28] = 0.5 * c8_b_b[c8_i28];
  }
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  real_T c8_u[3];
  const mxArray *c8_y = NULL;
  SFc8_QR2DsimInstanceStruct *chartInstance;
  chartInstance = (SFc8_QR2DsimInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_QR2Dsim_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c8_b_is_active_c8_QR2Dsim, const char_T *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_QR2Dsim), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_QR2Dsim);
  return c8_y;
}
...
void sf_c8_QR2Dsim_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3335254169U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(269603235U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1457895963U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3281021658U);
}

mxArray *sf_c8_QR2Dsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("YVRG2W0ommaMw7Vp6YiTgD");
...
mxArray *sf_c8_QR2Dsim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_QR2Dsim_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_QR2Dsim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"eR\",},{M[8],M[0],T\"is_active_c8_QR2Dsim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_QR2Dsim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_QR2DsimInstanceStruct *chartInstance;
    chartInstance = (SFc8_QR2DsimInstanceStruct *) ((ChartInfoStruct *)
...
{
  return "bEe1HxTpYJN6PWCsAxFomC";
}

static void sf_opaque_initialize_c8_QR2Dsim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_QR2DsimInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c8_QR2Dsim((SFc8_QR2DsimInstanceStruct*) chartInstanceVar);
  initialize_c8_QR2Dsim((SFc8_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_QR2Dsim(void *chartInstanceVar)
{
  enable_c8_QR2Dsim((SFc8_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_QR2Dsim(void *chartInstanceVar)
{
  disable_c8_QR2Dsim((SFc8_QR2DsimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_QR2Dsim(void *chartInstanceVar)
{
  sf_c8_QR2Dsim((SFc8_QR2DsimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_QR2Dsim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_QR2Dsim((SFc8_QR2DsimInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_QR2Dsim();/* state var info */
...
extern void sf_internal_set_sim_state_c8_QR2Dsim(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_QR2Dsim((SFc8_QR2DsimInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_QR2Dsim(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_QR2Dsim(S);
}

static void sf_opaque_set_sim_state_c8_QR2Dsim(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_QR2Dsim(S, st);
}

static void sf_opaque_terminate_c8_QR2Dsim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_QR2DsimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_QR2Dsim_optimization_info();
    }

    finalize_c8_QR2Dsim((SFc8_QR2DsimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_QR2Dsim((SFc8_QR2DsimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_QR2Dsim(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c8_QR2Dsim((SFc8_QR2DsimInstanceStruct*)(((ChartInfoStruct
      *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_QR2Dsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(905474373U));
  ssSetChecksum1(S,(1430496236U));
  ssSetChecksum2(S,(1800890101U));
  ssSetChecksum3(S,(1596148678U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c8_QR2Dsim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_QR2Dsim(SimStruct *S)
{
  SFc8_QR2DsimInstanceStruct *chartInstance;
  chartInstance = (SFc8_QR2DsimInstanceStruct *)utMalloc(sizeof
    (SFc8_QR2DsimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_QR2DsimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c8_QR2Dsim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c8_QR2Dsim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_QR2Dsim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_QR2Dsim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_QR2Dsim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c8_QR2Dsim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c8_QR2Dsim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c8_QR2Dsim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_QR2Dsim;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_QR2Dsim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_QR2Dsim;
...
void c8_QR2Dsim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_QR2Dsim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_QR2Dsim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_QR2Dsim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_QR2Dsim_method_dispatcher.\n"
