...
static const char * c44_debug_family_names[12] = { "p", "q", "r", "Omegahat",
  "nargin", "nargout", "R", "Rc", "Omega", "Omegac", "dOmegac", "Out" };
...
static void c44_emlrt_marshallIn(SFc44_QRLsimInstanceStruct *chartInstance,
  const mxArray *c44_Out, const char_T *c44_identifier, real_T c44_y[3]);
...
static const mxArray *c44_c_sf_marshallOut(void *chartInstanceVoid, void
  *c44_inData);
static real_T c44_c_emlrt_marshallIn(SFc44_QRLsimInstanceStruct *chartInstance,
...
static const mxArray *c44_d_sf_marshallOut(void *chartInstanceVoid, void
  *c44_inData);
static int32_T c44_e_emlrt_marshallIn(SFc44_QRLsimInstanceStruct *chartInstance,
  const mxArray *c44_u, const emlrtMsgIdentifier *c44_parentId);
static void c44_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c44_mxArrayInData, const char_T *c44_varName, void *c44_outData);
static uint8_T c44_f_emlrt_marshallIn(SFc44_QRLsimInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  real_T (*c44_Out)[3];
  c44_Out = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c44_st = NULL;
  c44_st = NULL;
  c44_y = NULL;
  sf_mex_assign(&c44_y, sf_mex_createcellarray(2), FALSE);
  for (c44_i0 = 0; c44_i0 < 3; c44_i0++) {
    c44_u[c44_i0] = (*c44_Out)[c44_i0];
  }
  ...
  const mxArray *c44_st)
{
  ...
  for (c44_i1 = 0; c44_i1 < 3; c44_i1++) {
    (*c44_Out)[c44_i1] = c44_dv0[c44_i1];
  }

  chartInstance->c44_is_active_c44_QRLsim = c44_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c44_u, 1)), "is_active_c44_QRLsim");
...
static void sf_c44_QRLsim(SFc44_QRLsimInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 13U, chartInstance->c44_sfEvent);
  for (c44_i2 = 0; c44_i2 < 9; c44_i2++) {
    _SFD_DATA_RANGE_CHECK((*c44_R)[c44_i2], 0U);
  }

  for (c44_i3 = 0; c44_i3 < 9; c44_i3++) {
    _SFD_DATA_RANGE_CHECK((*c44_Rc)[c44_i3], 1U);
  }

  for (c44_i4 = 0; c44_i4 < 3; c44_i4++) {
    _SFD_DATA_RANGE_CHECK((*c44_Out)[c44_i4], 2U);
  }

  for (c44_i5 = 0; c44_i5 < 3; c44_i5++) {
    _SFD_DATA_RANGE_CHECK((*c44_Omega)[c44_i5], 3U);
  }

  for (c44_i6 = 0; c44_i6 < 3; c44_i6++) {
    _SFD_DATA_RANGE_CHECK((*c44_Omegac)[c44_i6], 4U);
  }

  for (c44_i7 = 0; c44_i7 < 3; c44_i7++) {
    _SFD_DATA_RANGE_CHECK((*c44_dOmegac)[c44_i7], 5U);
  }
...
static void c44_chartstep_c44_QRLsim(SFc44_QRLsimInstanceStruct *chartInstance)
{
  ...
  int32_T c44_i12;
  real_T c44_dOmegac[3];
  uint32_T c44_debug_family_var_map[12];
  real_T c44_p;
  real_T c44_q;
  real_T c44_r;
  ...
  c44_b_Out = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c44_b_Rc = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
  c44_b_R = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 13U, chartInstance->c44_sfEvent);
  for (c44_i8 = 0; c44_i8 < 9; c44_i8++) {
    c44_R[c44_i8] = (*c44_b_R)[c44_i8];
  }

  for (c44_i9 = 0; c44_i9 < 9; c44_i9++) {
    c44_Rc[c44_i9] = (*c44_b_Rc)[c44_i9];
  }

  for (c44_i10 = 0; c44_i10 < 3; c44_i10++) {
    c44_Omega[c44_i10] = (*c44_b_Omega)[c44_i10];
  }

  for (c44_i11 = 0; c44_i11 < 3; c44_i11++) {
    c44_Omegac[c44_i11] = (*c44_b_Omegac)[c44_i11];
  }

  for (c44_i12 = 0; c44_i12 < 3; c44_i12++) {
    c44_dOmegac[c44_i12] = (*c44_b_dOmegac)[c44_i12];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 12U, 12U, c44_debug_family_names,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c44_r, 2U, c44_c_sf_marshallOut,
    c44_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c44_Omegahat, 3U, c44_b_sf_marshallOut,
    c44_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c44_nargout, 5U, c44_c_sf_marshallOut,
    c44_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c44_R, 6U, c44_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c44_Rc, 7U, c44_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c44_Omega, 8U, c44_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c44_Omegac, 9U, c44_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c44_dOmegac, 10U, c44_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c44_Out, 11U, c44_sf_marshallOut,
    c44_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c44_i13 = 0; c44_i13 < 9; c44_i13++) {
    c44_a[c44_i13] = c44_Omegahat[c44_i13];
  }

  c44_i14 = 0;
  for (c44_i15 = 0; c44_i15 < 3; c44_i15++) {
    c44_i16 = 0;
    for (c44_i17 = 0; c44_i17 < 3; c44_i17++) {
      c44_b[c44_i17 + c44_i14] = c44_R[c44_i16 + c44_i15];
      c44_i16 += 3;
    }
  ...
  for (c44_i18 = 0; c44_i18 < 3; c44_i18++) {
    c44_i19 = 0;
    for (c44_i20 = 0; c44_i20 < 3; c44_i20++) {
      c44_y[c44_i19 + c44_i18] = 0.0;
      c44_i21 = 0;
      for (c44_i22 = 0; c44_i22 < 3; c44_i22++) {
        c44_y[c44_i19 + c44_i18] += c44_a[c44_i21 + c44_i18] * c44_b[c44_i22 +
          c44_i19];
        c44_i21 += 3;
      }
  ...
  for (c44_i23 = 0; c44_i23 < 9; c44_i23++) {
    c44_b[c44_i23] = c44_Rc[c44_i23];
  }
  ...
  for (c44_i24 = 0; c44_i24 < 3; c44_i24++) {
    ...
    for (c44_i26 = 0; c44_i26 < 3; c44_i26++) {
      c44_a[c44_i25 + c44_i24] = 0.0;
      c44_i27 = 0;
      for (c44_i28 = 0; c44_i28 < 3; c44_i28++) {
        c44_a[c44_i25 + c44_i24] += c44_y[c44_i27 + c44_i24] * c44_b[c44_i28 +
          c44_i25];
        c44_i27 += 3;
      }
  ...
  for (c44_i29 = 0; c44_i29 < 3; c44_i29++) {
    c44_b_b[c44_i29] = c44_Omegac[c44_i29];
  }
  ...
  for (c44_i30 = 0; c44_i30 < 3; c44_i30++) {
    ...
    for (c44_i32 = 0; c44_i32 < 3; c44_i32++) {
      c44_b_y[c44_i30] += c44_a[c44_i31 + c44_i30] * c44_b_b[c44_i32];
      c44_i31 += 3;
    }
  }
  ...
  for (c44_i34 = 0; c44_i34 < 3; c44_i34++) {
    ...
    for (c44_i36 = 0; c44_i36 < 3; c44_i36++) {
      c44_a[c44_i36 + c44_i33] = c44_R[c44_i35 + c44_i34];
      c44_i35 += 3;
    }
  ...
  for (c44_i37 = 0; c44_i37 < 9; c44_i37++) {
    c44_b[c44_i37] = c44_Rc[c44_i37];
  }
  ...
  for (c44_i38 = 0; c44_i38 < 3; c44_i38++) {
    ...
    for (c44_i40 = 0; c44_i40 < 3; c44_i40++) {
      c44_y[c44_i39 + c44_i38] = 0.0;
      c44_i41 = 0;
      for (c44_i42 = 0; c44_i42 < 3; c44_i42++) {
        c44_y[c44_i39 + c44_i38] += c44_a[c44_i41 + c44_i38] * c44_b[c44_i42 +
          c44_i39];
        c44_i41 += 3;
      }
  ...
  for (c44_i43 = 0; c44_i43 < 3; c44_i43++) {
    c44_b_b[c44_i43] = c44_dOmegac[c44_i43];
  }
  ...
  for (c44_i44 = 0; c44_i44 < 3; c44_i44++) {
    ...
    for (c44_i46 = 0; c44_i46 < 3; c44_i46++) {
      c44_c_y[c44_i44] += c44_y[c44_i45 + c44_i44] * c44_b_b[c44_i46];
      c44_i45 += 3;
    }
  }

  for (c44_i47 = 0; c44_i47 < 3; c44_i47++) {
    c44_Out[c44_i47] = c44_b_y[c44_i47] - c44_c_y[c44_i47];
  }

  _SFD_EML_CALL(0U, chartInstance->c44_sfEvent, -12);
  _SFD_SYMBOL_SCOPE_POP();
  for (c44_i48 = 0; c44_i48 < 3; c44_i48++) {
    (*c44_b_Out)[c44_i48] = c44_Out[c44_i48];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 13U, chartInstance->c44_sfEvent);
}
  ...
  *c44_inData)
{
  ...
  for (c44_i49 = 0; c44_i49 < 3; c44_i49++) {
    c44_b_inData[c44_i49] = (*(real_T (*)[3])c44_inData)[c44_i49];
  }

  for (c44_i50 = 0; c44_i50 < 3; c44_i50++) {
    c44_u[c44_i50] = c44_b_inData[c44_i50];
  }
  ...
  const mxArray *c44_Out, const char_T *c44_identifier, real_T c44_y[3])
{
  ...
  c44_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c44_Out), &c44_thisId, c44_y);
  sf_mex_destroy(&c44_Out);
}
  ...
  const mxArray *c44_u, const emlrtMsgIdentifier *c44_parentId, real_T c44_y[3])
{
  real_T c44_dv1[3];
  int32_T c44_i51;
  sf_mex_import(c44_parentId, sf_mex_dup(c44_u), c44_dv1, 1, 0, 0U, 1, 0U, 1, 3);
  for (c44_i51 = 0; c44_i51 < 3; c44_i51++) {
    c44_y[c44_i51] = c44_dv1[c44_i51];
  }
  ...
  *c44_mxArrayInData, const char_T *c44_varName, void *c44_outData)
{
  ...
  SFc44_QRLsimInstanceStruct *chartInstance;
  chartInstance = (SFc44_QRLsimInstanceStruct *)chartInstanceVoid;
  c44_Out = sf_mex_dup(c44_mxArrayInData);
  ...
  for (c44_i52 = 0; c44_i52 < 3; c44_i52++) {
    (*(real_T (*)[3])c44_outData)[c44_i52] = c44_y[c44_i52];
  }
  ...
  *c44_inData)
{
  ...
  for (c44_i54 = 0; c44_i54 < 3; c44_i54++) {
    for (c44_i55 = 0; c44_i55 < 3; c44_i55++) {
      c44_b_inData[c44_i55 + c44_i53] = (*(real_T (*)[9])c44_inData)[c44_i55 +
        c44_i53];
    }
  ...
  for (c44_i57 = 0; c44_i57 < 3; c44_i57++) {
    for (c44_i58 = 0; c44_i58 < 3; c44_i58++) {
      c44_u[c44_i58 + c44_i56] = c44_b_inData[c44_i58 + c44_i56];
    }
  ...
  const mxArray *c44_u, const emlrtMsgIdentifier *c44_parentId, real_T c44_y[9])
{
  real_T c44_dv2[9];
  int32_T c44_i59;
  sf_mex_import(c44_parentId, sf_mex_dup(c44_u), c44_dv2, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c44_i59 = 0; c44_i59 < 9; c44_i59++) {
    c44_y[c44_i59] = c44_dv2[c44_i59];
  }
  ...
  *c44_mxArrayInData, const char_T *c44_varName, void *c44_outData)
{
  ...
  SFc44_QRLsimInstanceStruct *chartInstance;
  chartInstance = (SFc44_QRLsimInstanceStruct *)chartInstanceVoid;
  c44_Omegahat = sf_mex_dup(c44_mxArrayInData);
  c44_identifier = c44_varName;
  c44_thisId.fIdentifier = c44_identifier;
  c44_thisId.fParent = NULL;
  c44_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c44_Omegahat), &c44_thisId,
    c44_y);
  sf_mex_destroy(&c44_Omegahat);
  c44_i60 = 0;
  for (c44_i61 = 0; c44_i61 < 3; c44_i61++) {
    for (c44_i62 = 0; c44_i62 < 3; c44_i62++) {
      (*(real_T (*)[9])c44_outData)[c44_i62 + c44_i60] = c44_y[c44_i62 + c44_i60];
    }
  ...
  const mxArray *c44_u, const emlrtMsgIdentifier *c44_parentId)
{
  int32_T c44_y;
  int32_T c44_i63;
  sf_mex_import(c44_parentId, sf_mex_dup(c44_u), &c44_i63, 1, 6, 0U, 0, 0U, 0);
  c44_y = c44_i63;
  sf_mex_destroy(&c44_u);
  return c44_y;
}
  ...
  *c44_mxArrayInData, const char_T *c44_varName, void *c44_outData)
{
  ...
  c44_thisId.fIdentifier = c44_identifier;
  c44_thisId.fParent = NULL;
  c44_y = c44_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c44_b_sfEvent),
    &c44_thisId);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1625605727U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1760621165U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(29323806U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2946671181U);
}
...
mxArray *sf_c44_QRLsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("5ELcTvzGq8pEcErtGTOlxG");
...
static const mxArray *sf_get_sim_state_info_c44_QRLsim(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"Out\",},{M[8],M[0],T\"is_active_c44_QRLsim\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(2U, *c44_Out);
...
static void mdlSetWorkWidths_c44_QRLsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2450958809U));
  ssSetChecksum1(S,(1087439773U));
  ssSetChecksum2(S,(517751030U));
  ssSetChecksum3(S,(502464357U));
