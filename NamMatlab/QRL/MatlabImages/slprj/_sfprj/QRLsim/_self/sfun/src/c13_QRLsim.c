...
static const char * c13_debug_family_names[9] = { "b", "d", "l", "nargin",
  "nargout", "var", "omegarot", "f", "M" };
...
static void c13_chartstep_c13_QRLsim(SFc13_QRLsimInstanceStruct *chartInstance);
...
static void c13_emlrt_marshallIn(SFc13_QRLsimInstanceStruct *chartInstance,
  const mxArray *c13_M, const char_T *c13_identifier, real_T c13_y[3]);
...
static real_T c13_c_emlrt_marshallIn(SFc13_QRLsimInstanceStruct *chartInstance,
  const mxArray *c13_f, const char_T *c13_identifier);
static real_T c13_d_emlrt_marshallIn(SFc13_QRLsimInstanceStruct *chartInstance,
...
static void c13_eml_scalar_eg(SFc13_QRLsimInstanceStruct *chartInstance);
static void c13_b_eml_scalar_eg(SFc13_QRLsimInstanceStruct *chartInstance);
static const mxArray *c13_d_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_e_emlrt_marshallIn(SFc13_QRLsimInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
...
static uint8_T c13_g_emlrt_marshallIn(SFc13_QRLsimInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
  ...
  const mxArray *c13_st)
{
  ...
  c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 0)), "M",
                       c13_dv0);
  for (c13_i1 = 0; c13_i1 < 3; c13_i1++) {
    (*c13_M)[c13_i1] = c13_dv0[c13_i1];
  }

  *c13_f = c13_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u,
    1)), "f");
  chartInstance->c13_is_active_c13_QRLsim = c13_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c13_u, 2)), "is_active_c13_QRLsim");
...
static void sf_c13_QRLsim(SFc13_QRLsimInstanceStruct *chartInstance)
{
  ...
  int32_T c13_i4;
  real_T *c13_f;
  real_T (*c13_omegarot)[4];
  real_T (*c13_M)[3];
  real_T (*c13_var)[3];
  c13_omegarot = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S, 1);
  c13_M = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 2);
  c13_f = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c13_var = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c13_sfEvent);
  for (c13_i2 = 0; c13_i2 < 3; c13_i2++) {
    _SFD_DATA_RANGE_CHECK((*c13_var)[c13_i2], 0U);
  }

  _SFD_DATA_RANGE_CHECK(*c13_f, 1U);
  for (c13_i3 = 0; c13_i3 < 3; c13_i3++) {
    _SFD_DATA_RANGE_CHECK((*c13_M)[c13_i3], 2U);
  }

  for (c13_i4 = 0; c13_i4 < 4; c13_i4++) {
    _SFD_DATA_RANGE_CHECK((*c13_omegarot)[c13_i4], 3U);
  }

  chartInstance->c13_sfEvent = CALL_EVENT;
  c13_chartstep_c13_QRLsim(chartInstance);
...
static void c13_chartstep_c13_QRLsim(SFc13_QRLsimInstanceStruct *chartInstance)
{
  ...
  real_T *c13_b_f;
  real_T (*c13_b_M)[3];
  real_T (*c13_b_omegarot)[4];
  real_T (*c13_b_var)[3];
  c13_b_omegarot = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S, 1);
  c13_b_M = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 2);
  c13_b_f = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c13_b_var = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c13_sfEvent);
  for (c13_i5 = 0; c13_i5 < 3; c13_i5++) {
    c13_var[c13_i5] = (*c13_b_var)[c13_i5];
  }

  for (c13_i6 = 0; c13_i6 < 4; c13_i6++) {
    c13_omegarot[c13_i6] = (*c13_b_omegarot)[c13_i6];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 9U, 9U, c13_debug_family_names,
    c13_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c13_b, 0U, c13_b_sf_marshallOut,
    c13_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c13_d, 1U, c13_b_sf_marshallOut,
    c13_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c13_l, 2U, c13_b_sf_marshallOut,
    c13_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c13_nargout, 4U, c13_b_sf_marshallOut,
    c13_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c13_var, 5U, c13_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c13_omegarot, 6U, c13_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c13_f, 7U, c13_b_sf_marshallOut,
    c13_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c13_M, 8U, c13_sf_marshallOut,
    c13_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c13_i7 = 0; c13_i7 < 4; c13_i7++) {
    c13_b_b[c13_i7] = c13_omegarot[c13_i7];
  }
  ...
  for (c13_k = 1; c13_k < 5; c13_k++) {
    c13_b_k = c13_k;
    c13_f += c13_a[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
      "", (real_T)c13_b_k), 1, 4, 1, 0) - 1] *
  ...
  c13_b_a = -c13_l;
  c13_c_b = c13_b;
  c13_y = c13_b_a * c13_c_b;
  c13_c_a = c13_l;
  c13_d_b = c13_b;
  c13_b_y = c13_c_a * c13_d_b;
  c13_d_a = c13_l;
  c13_e_b = c13_b;
  c13_c_y = c13_d_a * c13_e_b;
  c13_e_a = -c13_l;
  c13_f_b = c13_b;
  c13_d_y = c13_e_a * c13_f_b;
  c13_f_a[0] = 0.0;
  c13_f_a[3] = c13_y;
  c13_f_a[6] = 0.0;
  c13_f_a[9] = c13_b_y;
  ...
  for (c13_i8 = 0; c13_i8 < 4; c13_i8++) {
    c13_b_b[c13_i8] = c13_omegarot[c13_i8];
  }
  ...
  for (c13_i11 = 0; c13_i11 < 3; c13_i11++) {
    c13_C[c13_i11] = c13_M[c13_i11];
  }

  for (c13_i12 = 0; c13_i12 < 3; c13_i12++) {
    c13_M[c13_i12] = c13_C[c13_i12];
  }

  for (c13_i13 = 0; c13_i13 < 3; c13_i13++) {
    c13_C[c13_i13] = c13_M[c13_i13];
  }

  for (c13_i14 = 0; c13_i14 < 3; c13_i14++) {
    c13_M[c13_i14] = c13_C[c13_i14];
  }
  ...
  for (c13_i15 = 0; c13_i15 < 3; c13_i15++) {
    ...
    for (c13_i17 = 0; c13_i17 < 4; c13_i17++) {
      c13_M[c13_i15] += c13_f_a[c13_i16 + c13_i15] * c13_b_b[c13_i17];
      c13_i16 += 3;
    }
  }
  ...
  *c13_inData)
{
  ...
  for (c13_i19 = 0; c13_i19 < 3; c13_i19++) {
    c13_b_inData[c13_i19] = (*(real_T (*)[3])c13_inData)[c13_i19];
  }
  ...
  const mxArray *c13_M, const char_T *c13_identifier, real_T c13_y[3])
{
  ...
  c13_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c13_M), &c13_thisId, c13_y);
  sf_mex_destroy(&c13_M);
}
  ...
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData)
{
  ...
  SFc13_QRLsimInstanceStruct *chartInstance;
  chartInstance = (SFc13_QRLsimInstanceStruct *)chartInstanceVoid;
  c13_M = sf_mex_dup(c13_mxArrayInData);
  ...
  for (c13_i22 = 0; c13_i22 < 3; c13_i22++) {
    (*(real_T (*)[3])c13_outData)[c13_i22] = c13_y[c13_i22];
  }
  ...
  const mxArray *c13_f, const char_T *c13_identifier)
{
  ...
  c13_thisId.fIdentifier = c13_identifier;
  c13_thisId.fParent = NULL;
  c13_y = c13_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c13_f), &c13_thisId);
  sf_mex_destroy(&c13_f);
  return c13_y;
}
  ...
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData)
{
  ...
  SFc13_QRLsimInstanceStruct *chartInstance;
  chartInstance = (SFc13_QRLsimInstanceStruct *)chartInstanceVoid;
  c13_f = sf_mex_dup(c13_mxArrayInData);
  c13_identifier = c13_varName;
  c13_thisId.fIdentifier = c13_identifier;
  c13_thisId.fParent = NULL;
  c13_y = c13_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c13_f), &c13_thisId);
  ...
  *c13_inData)
{
  ...
  for (c13_i23 = 0; c13_i23 < 4; c13_i23++) {
    c13_b_inData[c13_i23] = (*(real_T (*)[4])c13_inData)[c13_i23];
  }
...
const mxArray *sf_c13_QRLsim_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c13_nameCaptureInfo, sf_mex_createstruct("structure", 2, 27, 1),
                FALSE);
...
static void c13_info_helper(const mxArray **c13_info)
{
  ...
  sf_mex_addfield(*c13_info, c13_emlrt_marshallOut("mtimes"), "name", "name", 0);
  ...
  sf_mex_addfield(*c13_info, c13_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdot.m"), "resolved",
                  "resolved", 6);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(1363713868U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c13_info, c13_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdot.m"),
                  "resolved", "resolved", 9);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(1299076772U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(1286818778U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(1286818780U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(1346510340U), "fileTimeLo",
                  "fileTimeLo", 19);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 19);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c13_info, c13_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 20);
  sf_mex_addfield(*c13_info, c13_emlrt_marshallOut("intmax"), "name", "name", 20);
  sf_mex_addfield(*c13_info, c13_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c13_info, c13_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
                  "resolved", 20);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(1362261882U), "fileTimeLo",
                  "fileTimeLo", 20);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 20);
  sf_mex_addfield(*c13_info, c13_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2539758087U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(898442279U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(394987238U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(739055550U);
}
...
mxArray *sf_c13_QRLsim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("syQ5Vh2kSliCm4tyDPKGUG");
...
static const mxArray *sf_get_sim_state_info_c13_QRLsim(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[4],T\"M\",},{M[1],M[6],T\"f\",},{M[8],M[0],T\"is_active_c13_QRLsim\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(3,1,1,0,"omegarot");
...

        {
          ...
          c13_f = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c13_var = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c13_var);
          _SFD_SET_DATA_VALUE_PTR(1U, c13_f);
          _SFD_SET_DATA_VALUE_PTR(2U, *c13_M);
          _SFD_SET_DATA_VALUE_PTR(3U, *c13_omegarot);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c13_QRLsim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2737148890U));
  ssSetChecksum1(S,(40850406U));
  ssSetChecksum2(S,(3870232238U));
  ssSetChecksum3(S,(4103962197U));
